 ...
 3a8:	89 d1                	mov    %edx,%ecx
{
 ...
 3eb:	0f b6 92 5c 08 00 00 	movzbl 0x85c(%edx),%edx
 ...
 641:	a1 08 0b 00 00       	mov    0xb08,%eax
{
 ...
 689:	5b                   	pop    %ebx
  freep = p;
 68a:	89 15 08 0b 00 00    	mov    %edx,0xb08
}
 690:	5e                   	pop    %esi
 691:	5f                   	pop    %edi
 692:	5d                   	pop    %ebp
 ...
 6c7:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 6ca:	89 15 08 0b 00 00    	mov    %edx,0xb08
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6e9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6ec:	8b 15 08 0b 00 00    	mov    0xb08,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 72b:	39 05 08 0b 00 00    	cmp    %eax,0xb08
 ...
 74e:	e8 ed fe ff ff       	call   640 <free>
  return freep;
 753:	8b 15 08 0b 00 00    	mov    0xb08,%edx
 ...
 797:	0b 00 00 
    base.s.size = 0;
 79a:	b8 0c 0b 00 00       	mov    $0xb0c,%eax
    base.s.ptr = freep = prevp = &base;
 79f:	c7 05 0c 0b 00 00 0c 	movl   $0xb0c,0xb0c
 7a6:	0b 00 00 
    base.s.size = 0;
 7a9:	c7 05 10 0b 00 00 00 	movl   $0x0,0xb10
 7b0:	00 00 00 
    if(p->s.size >= nunits){
