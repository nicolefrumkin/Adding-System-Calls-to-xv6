 ...
 3a8:	89 d1                	mov    %edx,%ecx
{
 ...
 3eb:	0f b6 92 3c 08 00 00 	movzbl 0x83c(%edx),%edx
 ...
 641:	a1 e8 0a 00 00       	mov    0xae8,%eax
{
 ...
 689:	5b                   	pop    %ebx
  freep = p;
 68a:	89 15 e8 0a 00 00    	mov    %edx,0xae8
}
 690:	5e                   	pop    %esi
 691:	5f                   	pop    %edi
 692:	5d                   	pop    %ebp
 ...
 6c7:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 6ca:	89 15 e8 0a 00 00    	mov    %edx,0xae8
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 72b:	39 05 e8 0a 00 00    	cmp    %eax,0xae8
 ...
 74e:	e8 ed fe ff ff       	call   640 <free>
  return freep;
 753:	8b 15 e8 0a 00 00    	mov    0xae8,%edx
 ...
 77c:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 77f:	89 15 e8 0a 00 00    	mov    %edx,0xae8
}
 ...
 797:	0a 00 00 
    base.s.size = 0;
 79a:	b8 ec 0a 00 00       	mov    $0xaec,%eax
    base.s.ptr = freep = prevp = &base;
 79f:	c7 05 ec 0a 00 00 ec 	movl   $0xaec,0xaec
 7a6:	0a 00 00 
    base.s.size = 0;
 7a9:	c7 05 f0 0a 00 00 00 	movl   $0x0,0xaf0
 7b0:	00 00 00 
    if(p->s.size >= nunits){
