 ...
 388:	89 d1                	mov    %edx,%ecx
{
 ...
 3cb:	0f b6 92 1c 08 00 00 	movzbl 0x81c(%edx),%edx
 ...
 449:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 4b3:	ff 24 85 c4 07 00 00 	jmp    *0x7c4(,%eax,4)
 ...
 5e8:	bf bc 07 00 00       	mov    $0x7bc,%edi
...
free(void *ap)
{
 ...
 621:	a1 c8 0a 00 00       	mov    0xac8,%eax
{
 ...
 669:	5b                   	pop    %ebx
  freep = p;
 66a:	89 15 c8 0a 00 00    	mov    %edx,0xac8
}
 670:	5e                   	pop    %esi
 671:	5f                   	pop    %edi
 672:	5d                   	pop    %ebp
 ...
 6a7:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 6aa:	89 15 c8 0a 00 00    	mov    %edx,0xac8
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 70b:	39 05 c8 0a 00 00    	cmp    %eax,0xac8
 ...
 72e:	e8 ed fe ff ff       	call   620 <free>
  return freep;
 733:	8b 15 c8 0a 00 00    	mov    0xac8,%edx
 ...
 75c:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 75f:	89 15 c8 0a 00 00    	mov    %edx,0xac8
}
 ...
 76f:	c3                   	ret
    base.s.ptr = freep = prevp = &base;
 770:	c7 05 c8 0a 00 00 cc 	movl   $0xacc,0xac8
 777:	0a 00 00 
    base.s.size = 0;
 77a:	b8 cc 0a 00 00       	mov    $0xacc,%eax
    base.s.ptr = freep = prevp = &base;
 77f:	c7 05 cc 0a 00 00 cc 	movl   $0xacc,0xacc
 786:	0a 00 00 
    base.s.size = 0;
 789:	c7 05 d0 0a 00 00 00 	movl   $0x0,0xad0
 790:	00 00 00 
    if(p->s.size >= nunits){
