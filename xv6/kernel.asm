...
8010021b:	e8 90 47 00 00       	call   801049b0 <acquire>
  b->refcnt--;
...
80100268:	5d                   	pop    %ebp
  release(&bcache.lock);
80100269:	e9 e2 46 00 00       	jmp    80104950 <release>
    panic("brelse");
...
801002a0:	e8 0b 47 00 00       	call   801049b0 <acquire>
  while(n > 0){
...
801002f6:	e8 55 46 00 00       	call   80104950 <release>
        ilock(ip);
801002fb:	5a                   	pop    %edx
...
8010034c:	e8 ff 45 00 00       	call   80104950 <release>
  ilock(ip);
80100351:	58                   	pop    %eax
...
801003b0:	e8 fb 02 00 00       	call   801006b0 <cprintf>
  cprintf("\n");
801003b5:	c7 04 24 df 7a 10 80 	movl   $0x80107adf,(%esp)
...
80100561:	e8 da 45 00 00       	call   80104b40 <memmove>
    memset(crt+pos, 0, sizeof(crt[0])*(24*80 - pos));
...
80100576:	e8 35 45 00 00       	call   80104ab0 <memset>
  outb(CRTPORT+1, pos);
...
801005cb:	e8 e0 43 00 00       	call   801049b0 <acquire>
  for(i = 0; i < n; i++)
...
80100604:	e8 47 43 00 00       	call   80104950 <release>
  ilock(ip);
80100609:	58                   	pop    %eax
...
8010064b:	0f b6 92 30 7b 10 80 	movzbl -0x7fef84d0(%edx),%edx
...
801007d8:	e8 d3 41 00 00       	call   801049b0 <acquire>
  if (fmt == 0)
...
801007fb:	e8 50 41 00 00       	call   80104950 <release>
...
801008b3:	e8 f8 40 00 00       	call   801049b0 <acquire>
  while((c = getc()) >= 0){
...
801008ed:	e8 5e 40 00 00       	call   80104950 <release>
  if(doprocdump) {
...
80100b14:	0f 85 f1 00 00 00    	jne    80100c0b <exec+0x15b>
  ...
  if((pgdir = setupkvm()) == 0)
80100b1a:	e8 91 67 00 00       	call   801072b0 <setupkvm>
...
80100b8b:	e8 50 65 00 00       	call   801070e0 <allocuvm>
...
80100bc1:	e8 4a 64 00 00       	call   80107010 <loaduvm>
...
80100c03:	e8 28 66 00 00       	call   80107230 <freevm>
  if(ip){
...
80100cca:	e8 d1 3f 00 00       	call   80104ca0 <strlen>
...
80100cd8:	83 e3 fc             	and    $0xfffffffc,%ebx
    if(copyout(pgdir, sp, argv[argc], strlen(argv[argc]) + 1) < 0)
80100cdb:	e8 c0 3f 00 00       	call   80104ca0 <strlen>
...
80100d5f:	e8 bc 67 00 00       	call   80107520 <copyout>
...
80100d9f:	e8 bc 3e 00 00       	call   80104c60 <safestrcpy>
  curproc->pgdir = pgdir;
...
80100dcb:	e8 b0 60 00 00       	call   80106e80 <switchuvm>
  freevm(oldpgdir);
80100dd0:	89 34 24             	mov    %esi,(%esp)
80100dd3:	e8 58 64 00 00       	call   80107230 <freevm>
  return 0;
...
80100e40:	e8 7b 39 00 00       	call   801047c0 <initlock>
}
...
80100e61:	e8 4a 3b 00 00       	call   801049b0 <acquire>
...
80100e91:	e8 ba 3a 00 00       	call   80104950 <release>
      return f;
    }
  }
  release(&ftable.lock);
...
80100eaa:	e8 a1 3a 00 00       	call   80104950 <release>
}
...
80100ecf:	e8 dc 3a 00 00       	call   801049b0 <acquire>
  if(f->ref < 1)
...
80100eec:	e8 5f 3a 00 00       	call   80104950 <release>
  return f;
}
...
80100f21:	e8 8a 3a 00 00       	call   801049b0 <acquire>
  if(f->ref < 1)
...
80100f5c:	e8 ef 39 00 00       	call   80104950 <release>
...
80100f8d:	5d                   	pop    %ebp
    release(&ftable.lock);
80100f8e:	e9 bd 39 00 00       	jmp    80104950 <release>
...
801012cd:	e8 de 37 00 00       	call   80104ab0 <memset>
  log_write(bp);
...
8010130a:	e8 a1 36 00 00       	call   801049b0 <acquire>
  for(ip = &icache.inode[0]; ip < &icache.inode[NINODE]; ip++){
...
80101377:	e8 d4 35 00 00       	call   80104950 <release>
...
801013a5:	e8 a6 35 00 00       	call   80104950 <release>
      return ip;
...
80101561:	e8 da 35 00 00       	call   80104b40 <memmove>
  brelse(bp);
...
80101596:	e8 25 32 00 00       	call   801047c0 <initlock>
  for(i = 0; i < NINODE; i++) {
...
801015a9:	81 c3 90 00 00 00    	add    $0x90,%ebx
    initsleeplock(&icache.inode[i].lock, "inode");
801015af:	e8 dc 30 00 00       	call   80104690 <initsleeplock>
  for(i = 0; i < NINODE; i++) {
...
801015dc:	e8 5f 35 00 00       	call   80104b40 <memmove>
  brelse(bp);
...
80101613:	68 44 7b 10 80       	push   $0x80107b44
...
801016ae:	e8 fd 33 00 00       	call   80104ab0 <memset>
      dip->type = type;
...
80101751:	e8 ea 33 00 00       	call   80104b40 <memmove>
  log_write(bp);
...
8010177f:	e8 2c 32 00 00       	call   801049b0 <acquire>
  ip->ref++;
80101784:	83 43 08 01          	addl   $0x1,0x8(%ebx)
  release(&icache.lock);
80101788:	c7 04 24 60 09 11 80 	movl   $0x80110960,(%esp)
8010178f:	e8 bc 31 00 00       	call   80104950 <release>
}
...
801017c2:	e8 09 2f 00 00       	call   801046d0 <acquiresleep>
  if(ip->valid == 0){
...
80101838:	e8 03 33 00 00       	call   80104b40 <memmove>
    brelse(bp);
...
80101893:	e8 d8 2e 00 00       	call   80104770 <holdingsleep>
...
801018ae:	5d                   	pop    %ebp
  releasesleep(&ip->lock);
801018af:	e9 7c 2e 00 00       	jmp    80104730 <releasesleep>
    panic("iunlock");
...
801018e0:	e8 eb 2d 00 00       	call   801046d0 <acquiresleep>
...
801018fa:	e8 31 2e 00 00       	call   80104730 <releasesleep>
  acquire(&icache.lock);
801018ff:	c7 04 24 60 09 11 80 	movl   $0x80110960,(%esp)
80101906:	e8 a5 30 00 00       	call   801049b0 <acquire>
  ip->ref--;
...
80101a43:	e8 28 2d 00 00       	call   80104770 <holdingsleep>
...
80101a5a:	e8 d1 2c 00 00       	call   80104730 <releasesleep>
  iput(ip);
...
80101b57:	e8 e4 2f 00 00       	call   80104b40 <memmove>
    brelse(bp);
...
80101c55:	e8 e6 2e 00 00       	call   80104b40 <memmove>
    log_write(bp);
...
80101cde:	e8 cd 2e 00 00       	call   80104bb0 <strncmp>
}
80101ce3:	c9                   	leave
80101ce4:	c3                   	ret
...
80101d3d:	e8 6e 2e 00 00       	call   80104bb0 <strncmp>
      continue;
...
80101dca:	e8 e1 2b 00 00       	call   801049b0 <acquire>
  ip->ref++;
80101dcf:	83 46 08 01          	addl   $0x1,0x8(%esi)
  release(&icache.lock);
80101dd3:	c7 04 24 60 09 11 80 	movl   $0x80110960,(%esp)
80101dda:	e8 71 2b 00 00       	call   80104950 <release>
...
80101e37:	e8 04 2d 00 00       	call   80104b40 <memmove>
...
80101e9c:	e8 cf 28 00 00       	call   80104770 <holdingsleep>
...
80101ebe:	e8 6d 28 00 00       	call   80104730 <releasesleep>
  iput(ip);
...
80101eeb:	e8 50 2c 00 00       	call   80104b40 <memmove>
    name[len] = 0;
...
80101f25:	e8 46 28 00 00       	call   80104770 <holdingsleep>
...
80101f3c:	e8 ef 27 00 00       	call   80104730 <releasesleep>
  iput(ip);
...
80101f75:	e8 f6 27 00 00       	call   80104770 <holdingsleep>
...
80101f8c:	e8 9f 27 00 00       	call   80104730 <releasesleep>
}
...
8010201d:	e8 de 2b 00 00       	call   80104c00 <strncpy>
  de.inum = inum;
...
80102068:	68 e3 79 10 80       	push   $0x801079e3
...
801021b0:	e8 0b 26 00 00       	call   801047c0 <initlock>
...
8010223e:	e8 6d 27 00 00       	call   801049b0 <acquire>
...
801022bb:	e8 90 26 00 00       	call   80104950 <release>
...
801022de:	e8 8d 24 00 00       	call   80104770 <holdingsleep>
...
80102318:	e8 93 26 00 00       	call   801049b0 <acquire>
...
80102375:	c9                   	leave
  release(&idelock);
80102376:	e9 d5 25 00 00       	jmp    80104950 <release>
...
8010240a:	68 98 7b 10 80       	push   $0x80107b98
...
801024d2:	e8 d9 25 00 00       	call   80104ab0 <memset>
...
80102522:	c9                   	leave
    release(&kmem.lock);
80102523:	e9 28 24 00 00       	jmp    80104950 <release>
    panic("kfree");
80102528:	83 ec 0c             	sub    $0xc,%esp
8010252b:	68 cc 77 10 80       	push   $0x801077cc
...
801025fb:	68 d2 77 10 80       	push   $0x801077d2
80102600:	68 40 26 11 80       	push   $0x80112640
80102605:	e8 b6 21 00 00       	call   801047c0 <initlock>
  p = (char*)PGROUNDUP((uint)vstart);
...
80102698:	e8 13 23 00 00       	call   801049b0 <acquire>
  r = kmem.freelist;
...
801026c3:	e8 88 22 00 00       	call   80104950 <release>
}
...
8010271b:	0f b6 91 00 7e 10 80 	movzbl -0x7fef8200(%ecx),%edx
  shift ^= togglecode[data];
80102722:	0f b6 81 00 7d 10 80 	movzbl -0x7fef8300(%ecx),%eax
  shift |= shiftcode[data];
...
80102738:	83 e2 08             	and    $0x8,%edx
  c = charcode[shift & (CTL | SHIFT)][data];
8010273b:	8b 04 85 e0 7c 10 80 	mov    -0x7fef8320(,%eax,4),%eax
...
80102775:	0f 44 c8             	cmove  %eax,%ecx
    shift &= ~(shiftcode[data] | E0ESC);
80102778:	0f b6 81 00 7e 10 80 	movzbl -0x7fef8200(%ecx),%eax
...
80102ad3:	e8 18 20 00 00       	call   80104af0 <memcmp>
...
80102c04:	e8 37 1f 00 00       	call   80104b40 <memmove>
...
80102caa:	68 d7 77 10 80       	push   $0x801077d7
80102caf:	68 a0 26 11 80       	push   $0x801126a0
80102cb4:	e8 07 1b 00 00       	call   801047c0 <initlock>
  readsb(dev, &sb);
80102cb9:	58                   	pop    %eax
...
80102d4b:	e8 60 1c 00 00       	call   801049b0 <acquire>
...
80102d9c:	e8 af 1b 00 00       	call   80104950 <release>
      break;
    }
  }
}
...
80102dbe:	e8 ed 1b 00 00       	call   801049b0 <acquire>
  log.outstanding -= 1;
...
80102dfc:	e8 4f 1b 00 00       	call   80104950 <release>
}
...
80102e16:	e8 95 1b 00 00       	call   801049b0 <acquire>
    log.committing = 0;
...
80102e38:	e8 13 1b 00 00       	call   80104950 <release>
...
80102e94:	e8 a7 1c 00 00       	call   80104b40 <memmove>
...
80102ef4:	e8 57 1a 00 00       	call   80104950 <release>
...
80102f07:	68 db 77 10 80       	push   $0x801077db
...
80102f98:	c9                   	leave
  release(&log.lock);
80102f99:	e9 b2 19 00 00       	jmp    80104950 <release>
...
80102fb5:	68 ea 77 10 80       	push   $0x801077ea
80102fba:	e8 c1 d3 ff ff       	call   80100380 <panic>
    panic("log_write outside of trans");
80102fbf:	83 ec 0c             	sub    $0xc,%esp
80102fc2:	68 00 78 10 80       	push   $0x80107800
...
80102fe8:	68 1b 78 10 80       	push   $0x8010781b
80102fed:	e8 be d6 ff ff       	call   801006b0 <cprintf>
  idtinit();       // load idt register
80102ff2:	e8 79 2d 00 00       	call   80105d70 <idtinit>
...
80103013:	83 ec 08             	sub    $0x8,%esp
  switchkvm();
80103016:	e8 55 3e 00 00       	call   80106e70 <switchkvm>
  seginit();
8010301b:	e8 c0 3d 00 00       	call   80106de0 <seginit>
  lapicinit();
...
80103074:	e8 d7 2f 00 00       	call   80106050 <uartinit>
  pinit();         // process table
80103079:	e8 22 09 00 00       	call   801039a0 <pinit>
  tvinit();        // trap vectors
8010307e:	e8 6d 2c 00 00       	call   80105cf0 <tvinit>
  binit();         // buffer cache
...
801030a4:	e8 97 1a 00 00       	call   80104b40 <memmove>
...
8010318e:	68 2f 78 10 80       	push   $0x8010782f
80103193:	56                   	push   %esi
80103194:	e8 57 19 00 00       	call   80104af0 <memcmp>
...
80103249:	68 34 78 10 80       	push   $0x80107834
8010324e:	50                   	push   %eax
8010324f:	e8 9c 18 00 00       	call   80104af0 <memcmp>
...
8010337b:	68 39 78 10 80       	push   $0x80107839
...
801033a2:	68 2f 78 10 80       	push   $0x8010782f
801033a7:	53                   	push   %ebx
801033a8:	e8 43 17 00 00       	call   80104af0 <memcmp>
...
801033d8:	68 cc 7b 10 80       	push   $0x80107bcc
...
80103480:	00 00 00 
  initlock(&p->lock, "pipe");
80103483:	68 51 78 10 80       	push   $0x80107851
80103488:	50                   	push   %eax
80103489:	e8 32 13 00 00       	call   801047c0 <initlock>
  (*f0)->type = FD_PIPE;
...
8010350f:	e8 9c 14 00 00       	call   801049b0 <acquire>
  if(writable){
...
80103553:	5d                   	pop    %ebp
    release(&p->lock);
80103554:	e9 f7 13 00 00       	jmp    80104950 <release>
80103559:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    release(&p->lock);
80103560:	83 ec 0c             	sub    $0xc,%esp
80103563:	53                   	push   %ebx
80103564:	e8 e7 13 00 00       	call   80104950 <release>
    kfree((char*)p);
...
801035b0:	e8 fb 13 00 00       	call   801049b0 <acquire>
  for(i = 0; i < n; i++){
...
80103644:	e8 07 13 00 00       	call   80104950 <release>
        return -1;
...
801036a0:	e8 ab 12 00 00       	call   80104950 <release>
  return n;
...
801036d6:	e8 d5 12 00 00       	call   801049b0 <acquire>
...
8010376e:	e8 dd 11 00 00       	call   80104950 <release>
  return i;
...
80103789:	e8 c2 11 00 00       	call   80104950 <release>
      return -1;
...
801037b1:	e8 fa 11 00 00       	call   801049b0 <acquire>
...
80103804:	89 15 04 b0 10 80    	mov    %edx,0x8010b004
  release(&ptable.lock);
8010380a:	e8 41 11 00 00       	call   80104950 <release>
...
8010382c:	89 53 18             	mov    %edx,0x18(%ebx)
  *(uint*)sp = (uint)trapret;
8010382f:	c7 40 14 d7 5c 10 80 	movl   $0x80105cd7,0x14(%eax)
  p->context = (struct context*)sp;
...
8010383e:	e8 6d 12 00 00       	call   80104ab0 <memset>
...
8010386a:	e8 e1 10 00 00       	call   80104950 <release>
  return 0;
...
8010389b:	e8 b0 10 00 00       	call   80104950 <release>
...
801039a6:	68 56 78 10 80       	push   $0x80107856
801039ab:	68 20 2d 11 80       	push   $0x80112d20
801039b0:	e8 0b 0e 00 00       	call   801047c0 <initlock>
}
...
80103a44:	83 ec 04             	sub    $0x4,%esp
  pushcli();
80103a47:	e8 14 0e 00 00       	call   80104860 <pushcli>
  c = mycpu();
80103a4c:	e8 6f ff ff ff       	call   801039c0 <mycpu>
  p = c->proc;
80103a51:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103a57:	e8 54 0e 00 00       	call   801048b0 <popcli>
}
...
80103a83:	e8 28 38 00 00       	call   801072b0 <setupkvm>
...
80103aa1:	e8 ea 34 00 00       	call   80106f90 <inituvm>
...
80103ab6:	e8 f5 0f 00 00       	call   80104ab0 <memset>
...
80103b0f:	68 86 78 10 80       	push   $0x80107886
80103b14:	50                   	push   %eax
80103b15:	e8 46 11 00 00       	call   80104c60 <safestrcpy>
  p->cwd = namei("/");
80103b1a:	c7 04 24 8f 78 10 80 	movl   $0x8010788f,(%esp)
...
80103b53:	68 6d 78 10 80       	push   $0x8010786d
...
80103b65:	8b 75 08             	mov    0x8(%ebp),%esi
  pushcli();
80103b68:	e8 f3 0c 00 00       	call   80104860 <pushcli>
  c = mycpu();
80103b6d:	e8 4e fe ff ff       	call   801039c0 <mycpu>
  p = c->proc;
80103b72:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103b78:	e8 33 0d 00 00       	call   801048b0 <popcli>
  sz = curproc->sz;
...
80103b8b:	e8 f0 32 00 00       	call   80106e80 <switchuvm>
  return 0;
...
80103baa:	e8 31 35 00 00       	call   801070e0 <allocuvm>
...
80103bca:	e8 31 36 00 00       	call   80107200 <deallocuvm>
...
80103be6:	83 ec 1c             	sub    $0x1c,%esp
  pushcli();
80103be9:	e8 72 0c 00 00       	call   80104860 <pushcli>
  c = mycpu();
80103bee:	e8 cd fd ff ff       	call   801039c0 <mycpu>
  p = c->proc;
80103bf3:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103bf9:	e8 b2 0c 00 00       	call   801048b0 <popcli>
  if((np = allocproc()) == 0){
...
80103c18:	e8 83 37 00 00       	call   801073a0 <copyuvm>
...
80103d2e:	e8 7d 0c 00 00       	call   801049b0 <acquire>
...
80103d5b:	c7 43 0c 04 00 00 00 	movl   $0x4,0xc(%ebx)
      swtch(&(c->scheduler), p->context);
80103d62:	e8 54 0f 00 00       	call   80104cbb <swtch>
      switchkvm();
...
80103d8f:	e8 bc 0b 00 00       	call   80104950 <release>
    sti();
...
80103da4:	53                   	push   %ebx
  pushcli();
80103da5:	e8 b6 0a 00 00       	call   80104860 <pushcli>
  c = mycpu();
80103daa:	e8 11 fc ff ff       	call   801039c0 <mycpu>
  p = c->proc;
80103daf:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103db5:	e8 f6 0a 00 00       	call   801048b0 <popcli>
...
80103dc6:	e8 45 0b 00 00       	call   80104910 <holding>
...
80103e07:	e8 af 0e 00 00       	call   80104cbb <swtch>
  mycpu()->intena = intena;
...
80103ed4:	e8 d7 0a 00 00       	call   801049b0 <acquire>
...
80103f87:	68 de 78 10 80       	push   $0x801078de
80103f8c:	e8 ef c3 ff ff       	call   80100380 <panic>
    panic("init exiting");
80103f91:	83 ec 0c             	sub    $0xc,%esp
80103f94:	68 d1 78 10 80       	push   $0x801078d1
...
80104011:	0f 85 8f 00 00 00    	jne    801040a6 <wait+0x106>
  pushcli();
80104017:	e8 44 08 00 00       	call   80104860 <pushcli>
  c = mycpu();
8010401c:	e8 9f f9 ff ff       	call   801039c0 <mycpu>
  p = c->proc;
80104021:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80104027:	e8 84 08 00 00       	call   801048b0 <popcli>
  if(p == 0)
...
80104069:	e8 c2 31 00 00       	call   80107230 <freevm>
        p->pid = 0;
...
80104095:	e8 b6 08 00 00       	call   80104950 <release>
        return pid;
...
801040dc:	e8 cf 08 00 00       	call   801049b0 <acquire>
  pushcli();
801040e1:	e8 7a 07 00 00       	call   80104860 <pushcli>
  c = mycpu();
801040e6:	e8 d5 f8 ff ff       	call   801039c0 <mycpu>
  p = c->proc;
801040eb:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
801040f1:	e8 ba 07 00 00       	call   801048b0 <popcli>
...
80104109:	e8 42 08 00 00       	call   80104950 <release>
}
...
8010412c:	8b 75 0c             	mov    0xc(%ebp),%esi
  pushcli();
8010412f:	e8 2c 07 00 00       	call   80104860 <pushcli>
  c = mycpu();
80104134:	e8 87 f8 ff ff       	call   801039c0 <mycpu>
  p = c->proc;
80104139:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
8010413f:	e8 6c 07 00 00       	call   801048b0 <popcli>
  if(p == 0)
...
80104160:	e8 4b 08 00 00       	call   801049b0 <acquire>
    release(lk);
80104165:	89 34 24             	mov    %esi,(%esp)
80104168:	e8 e3 07 00 00       	call   80104950 <release>
  p->chan = chan;
...
8010418a:	e8 c1 07 00 00       	call   80104950 <release>
    acquire(lk);
...
8010419b:	5d                   	pop    %ebp
    acquire(lk);
8010419c:	e9 0f 08 00 00       	jmp    801049b0 <acquire>
...
801041c9:	68 f0 78 10 80       	push   $0x801078f0
801041ce:	e8 ad c1 ff ff       	call   80100380 <panic>
    panic("sleep");
801041d3:	83 ec 0c             	sub    $0xc,%esp
801041d6:	68 ea 78 10 80       	push   $0x801078ea
...
801041ef:	e8 bc 07 00 00       	call   801049b0 <acquire>
...
80104234:	c9                   	leave
  release(&ptable.lock);
80104235:	e9 16 07 00 00       	jmp    80104950 <release>
...
8010424f:	e8 5c 07 00 00       	call   801049b0 <acquire>
...
8010428d:	e8 be 06 00 00       	call   80104950 <release>
}
...
801042a8:	e8 a3 06 00 00       	call   80104950 <release>
}
...
801042db:	68 df 7a 10 80       	push   $0x80107adf
...
801042ff:	74 e7                	je     801042e8 <procdump+0x28>
      state = "???";
80104301:	ba 01 79 10 80       	mov    $0x80107901,%edx
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
80104306:	83 f8 05             	cmp    $0x5,%eax
80104309:	77 11                	ja     8010431c <procdump+0x5c>
8010430b:	8b 14 85 14 7f 10 80 	mov    -0x7fef80ec(,%eax,4),%edx
      state = "???";
80104312:	b8 01 79 10 80       	mov    $0x80107901,%eax
...
80104321:	68 05 79 10 80       	push   $0x80107905
...
80104348:	e8 93 04 00 00       	call   801047e0 <getcallerpcs>
...
8010438e:	e8 1d 06 00 00       	call   801049b0 <acquire>
...
801043bb:	e8 90 05 00 00       	call   80104950 <release>
}
...
801043de:	e8 cd 05 00 00       	call   801049b0 <acquire>
...
80104413:	e8 38 05 00 00       	call   80104950 <release>
}
...
80104424:	bf 0e 79 10 80       	mov    $0x8010790e,%edi
...
80104437:	83 f8 04             	cmp    $0x4,%eax
8010443a:	77 07                	ja     80104443 <printPaddedString+0x23>
8010443c:	8b 3c 85 00 7f 10 80 	mov    -0x7fef8100(,%eax,4),%edi
    int len = strlen(state); // fixme to check
80104443:	83 ec 0c             	sub    $0xc,%esp
80104446:	57                   	push   %edi
80104447:	e8 54 08 00 00       	call   80104ca0 <strlen>
8010444c:	89 c3                	mov    %eax,%ebx
    cprintf("%s", state);
8010444e:	58                   	pop    %eax
8010444f:	5a                   	pop    %edx
80104450:	57                   	push   %edi
80104451:	68 0b 79 10 80       	push   $0x8010790b
80104456:	e8 55 c2 ff ff       	call   801006b0 <cprintf>
    for (int i = len; i < width; i++) {
8010445b:	83 c4 10             	add    $0x10,%esp
8010445e:	39 f3                	cmp    %esi,%ebx
80104460:	7d 1d                	jge    8010447f <printPaddedString+0x5f>
80104462:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
        cprintf(" ");
80104468:	83 ec 0c             	sub    $0xc,%esp
    for (int i = len; i < width; i++) {
8010446b:	83 c3 01             	add    $0x1,%ebx
        cprintf(" ");
8010446e:	68 5f 79 10 80       	push   $0x8010795f
80104473:	e8 38 c2 ff ff       	call   801006b0 <cprintf>
    for (int i = len; i < width; i++) {
80104478:	83 c4 10             	add    $0x10,%esp
8010447b:	39 de                	cmp    %ebx,%esi
8010447d:	75 e9                	jne    80104468 <printPaddedString+0x48>
}
8010447f:	8d 65 f4             	lea    -0xc(%ebp),%esp
80104482:	5b                   	pop    %ebx
80104483:	5e                   	pop    %esi
80104484:	5f                   	pop    %edi
80104485:	5d                   	pop    %ebp
...
801044a1:	74 5d                	je     80104500 <printPaddedInt+0x70>
801044a3:	8d 7d d8             	lea    -0x28(%ebp),%edi
801044a6:	b9 0a 00 00 00       	mov    $0xa,%ecx
801044ab:	89 fa                	mov    %edi,%edx
801044ad:	e8 2e f4 ff ff       	call   801038e0 <itoa.part.0>
    int len = strlen(buffer); // fixme to check
801044b2:	83 ec 0c             	sub    $0xc,%esp
801044b5:	57                   	push   %edi
801044b6:	e8 e5 07 00 00       	call   80104ca0 <strlen>
801044bb:	89 c3                	mov    %eax,%ebx
    cprintf("%s", buffer);
801044bd:	58                   	pop    %eax
801044be:	5a                   	pop    %edx
801044bf:	57                   	push   %edi
801044c0:	68 0b 79 10 80       	push   $0x8010790b
801044c5:	e8 e6 c1 ff ff       	call   801006b0 <cprintf>
    for (int i = len; i < width; i++) {
801044ca:	83 c4 10             	add    $0x10,%esp
801044cd:	39 f3                	cmp    %esi,%ebx
801044cf:	7d 1e                	jge    801044ef <printPaddedInt+0x5f>
801044d1:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
        cprintf(" ");
801044d8:	83 ec 0c             	sub    $0xc,%esp
    for (int i = len; i < width; i++) {
801044db:	83 c3 01             	add    $0x1,%ebx
        cprintf(" ");
801044de:	68 5f 79 10 80       	push   $0x8010795f
801044e3:	e8 c8 c1 ff ff       	call   801006b0 <cprintf>
    for (int i = len; i < width; i++) {
801044e8:	83 c4 10             	add    $0x10,%esp
801044eb:	39 de                	cmp    %ebx,%esi
801044ed:	75 e9                	jne    801044d8 <printPaddedInt+0x48>
}
801044ef:	8d 65 f4             	lea    -0xc(%ebp),%esp
801044f2:	5b                   	pop    %ebx
801044f3:	5e                   	pop    %esi
801044f4:	5f                   	pop    %edi
801044f5:	5d                   	pop    %ebp
801044f6:	c3                   	ret
801044f7:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
801044fe:	00 
801044ff:	90                   	nop
        str[i++] = '0';
80104500:	b9 30 00 00 00       	mov    $0x30,%ecx
80104505:	8d 7d d8             	lea    -0x28(%ebp),%edi
80104508:	66 89 4d d8          	mov    %cx,-0x28(%ebp)
        return;
8010450c:	eb a4                	jmp    801044b2 <printPaddedInt+0x22>
...
80104515:	53                   	push   %ebx
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++) {
80104516:	bb 54 2d 11 80       	mov    $0x80112d54,%ebx
int getProcInfo(int pid, struct processInfo* proc_info) {
8010451b:	83 ec 28             	sub    $0x28,%esp
8010451e:	8b 7d 08             	mov    0x8(%ebp),%edi
80104521:	8b 75 0c             	mov    0xc(%ebp),%esi
  acquire(&ptable.lock);
80104524:	68 20 2d 11 80       	push   $0x80112d20
80104529:	e8 82 04 00 00       	call   801049b0 <acquire>
8010452e:	83 c4 10             	add    $0x10,%esp
80104531:	eb 17                	jmp    8010454a <getProcInfo+0x3a>
80104533:	2e 8d 74 26 00       	lea    %cs:0x0(%esi,%eiz,1),%esi
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++) {
80104538:	81 c3 84 00 00 00    	add    $0x84,%ebx
8010453e:	81 fb 54 4e 11 80    	cmp    $0x80114e54,%ebx
80104544:	0f 84 e7 00 00 00    	je     80104631 <getProcInfo+0x121>
    if(p->pid == pid) {
8010454a:	39 7b 10             	cmp    %edi,0x10(%ebx)
8010454d:	75 e9                	jne    80104538 <getProcInfo+0x28>
      proc_info->state = p->state;
8010454f:	8b 43 0c             	mov    0xc(%ebx),%eax
80104552:	89 06                	mov    %eax,(%esi)
      proc_info->ppid = p->parent ? p->parent->pid : 0;
80104554:	8b 53 14             	mov    0x14(%ebx),%edx
80104557:	31 c0                	xor    %eax,%eax
80104559:	85 d2                	test   %edx,%edx
8010455b:	74 03                	je     80104560 <getProcInfo+0x50>
8010455d:	8b 42 10             	mov    0x10(%edx),%eax
80104560:	89 46 04             	mov    %eax,0x4(%esi)
      proc_info->sz = p->sz;
80104563:	8b 03                	mov    (%ebx),%eax
      printPaddedInt(pid, 10);
80104565:	83 ec 08             	sub    $0x8,%esp
      proc_info->sz = p->sz;
80104568:	89 46 08             	mov    %eax,0x8(%esi)
      proc_info->nrswitch = p->nrswitch; //FIXME -to do
8010456b:	8b 43 7c             	mov    0x7c(%ebx),%eax
8010456e:	89 46 10             	mov    %eax,0x10(%esi)
      printPaddedInt(pid, 10);
80104571:	6a 0a                	push   $0xa
80104573:	57                   	push   %edi
80104574:	e8 17 ff ff ff       	call   80104490 <printPaddedInt>
    switch(num) {
80104579:	8b 06                	mov    (%esi),%eax
8010457b:	83 c4 10             	add    $0x10,%esp
8010457e:	ba 0e 79 10 80       	mov    $0x8010790e,%edx
80104583:	83 e8 01             	sub    $0x1,%eax
80104586:	83 f8 04             	cmp    $0x4,%eax
80104589:	0f 86 c1 00 00 00    	jbe    80104650 <getProcInfo+0x140>
    int len = strlen(state); // fixme to check
8010458f:	83 ec 0c             	sub    $0xc,%esp
80104592:	52                   	push   %edx
80104593:	89 55 e4             	mov    %edx,-0x1c(%ebp)
80104596:	e8 05 07 00 00       	call   80104ca0 <strlen>
8010459b:	89 c7                	mov    %eax,%edi
    cprintf("%s", state);
8010459d:	58                   	pop    %eax
8010459e:	5a                   	pop    %edx
8010459f:	8b 55 e4             	mov    -0x1c(%ebp),%edx
801045a2:	52                   	push   %edx
801045a3:	68 0b 79 10 80       	push   $0x8010790b
801045a8:	e8 03 c1 ff ff       	call   801006b0 <cprintf>
    for (int i = len; i < width; i++) {
801045ad:	83 c4 10             	add    $0x10,%esp
801045b0:	83 ff 09             	cmp    $0x9,%edi
801045b3:	7f 1b                	jg     801045d0 <getProcInfo+0xc0>
801045b5:	8d 76 00             	lea    0x0(%esi),%esi
        cprintf(" ");
801045b8:	83 ec 0c             	sub    $0xc,%esp
    for (int i = len; i < width; i++) {
801045bb:	83 c7 01             	add    $0x1,%edi
        cprintf(" ");
801045be:	68 5f 79 10 80       	push   $0x8010795f
801045c3:	e8 e8 c0 ff ff       	call   801006b0 <cprintf>
    for (int i = len; i < width; i++) {
801045c8:	83 c4 10             	add    $0x10,%esp
801045cb:	83 ff 0a             	cmp    $0xa,%edi
801045ce:	75 e8                	jne    801045b8 <getProcInfo+0xa8>
      printPaddedInt(proc_info->ppid, 10);
801045d0:	83 ec 08             	sub    $0x8,%esp
801045d3:	6a 0a                	push   $0xa
801045d5:	ff 76 04             	push   0x4(%esi)
801045d8:	e8 b3 fe ff ff       	call   80104490 <printPaddedInt>
      printPaddedInt(proc_info->sz, 10);
801045dd:	59                   	pop    %ecx
801045de:	5f                   	pop    %edi
801045df:	6a 0a                	push   $0xa
801045e1:	ff 76 08             	push   0x8(%esi)
801045e4:	e8 a7 fe ff ff       	call   80104490 <printPaddedInt>
      printPaddedInt(proc_info->nfd, 10);
801045e9:	58                   	pop    %eax
801045ea:	5a                   	pop    %edx
801045eb:	6a 0a                	push   $0xa
801045ed:	ff 76 0c             	push   0xc(%esi)
801045f0:	e8 9b fe ff ff       	call   80104490 <printPaddedInt>
      printPaddedInt(proc_info->nrswitch, 10);
801045f5:	59                   	pop    %ecx
801045f6:	5f                   	pop    %edi
801045f7:	6a 0a                	push   $0xa
801045f9:	ff 76 10             	push   0x10(%esi)
801045fc:	e8 8f fe ff ff       	call   80104490 <printPaddedInt>
      cprintf("\n");
80104601:	c7 04 24 df 7a 10 80 	movl   $0x80107adf,(%esp)
80104608:	e8 a3 c0 ff ff       	call   801006b0 <cprintf>
      for(int i = 0; i<NOFILE; i++) {
8010460d:	8d 43 28             	lea    0x28(%ebx),%eax
80104610:	83 c4 10             	add    $0x10,%esp
80104613:	83 c3 68             	add    $0x68,%ebx
80104616:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
8010461d:	00 
8010461e:	66 90                	xchg   %ax,%ax
        if (p->ofile[i] != 0){
80104620:	8b 10                	mov    (%eax),%edx
80104622:	85 d2                	test   %edx,%edx
80104624:	74 04                	je     8010462a <getProcInfo+0x11a>
          proc_info->nfd++;
80104626:	83 46 0c 01          	addl   $0x1,0xc(%esi)
      for(int i = 0; i<NOFILE; i++) {
8010462a:	83 c0 04             	add    $0x4,%eax
8010462d:	39 d8                	cmp    %ebx,%eax
8010462f:	75 ef                	jne    80104620 <getProcInfo+0x110>
  release(&ptable.lock);
80104631:	83 ec 0c             	sub    $0xc,%esp
80104634:	68 20 2d 11 80       	push   $0x80112d20
80104639:	e8 12 03 00 00       	call   80104950 <release>
}
...
80104646:	5d                   	pop    %ebp
80104647:	c3                   	ret
80104648:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
8010464f:	00 
80104650:	8b 14 85 00 7f 10 80 	mov    -0x7fef8100(,%eax,4),%edx
80104657:	e9 33 ff ff ff       	jmp    8010458f <getProcInfo+0x7f>
...
80104669:	8b 4d 10             	mov    0x10(%ebp),%ecx
    if (num == 0) {
8010466c:	85 c0                	test   %eax,%eax
8010466e:	74 10                	je     80104680 <itoa+0x20>
}
80104670:	5d                   	pop    %ebp
80104671:	e9 6a f2 ff ff       	jmp    801038e0 <itoa.part.0>
80104676:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
8010467d:	00 
8010467e:	66 90                	xchg   %ax,%ax
        str[i++] = '0';
80104680:	b8 30 00 00 00       	mov    $0x30,%eax
80104685:	66 89 02             	mov    %ax,(%edx)
}
80104688:	5d                   	pop    %ebp
80104689:	c3                   	ret
...
8010469a:	68 68 79 10 80       	push   $0x80107968
...
801046df:	e8 cc 02 00 00       	call   801049b0 <acquire>
  while (lk->locked) {
...
801046f5:	e8 26 fa ff ff       	call   80104120 <sleep>
  while (lk->locked) {
...
80104703:	c7 03 01 00 00 00    	movl   $0x1,(%ebx)
  lk->pid = myproc()->pid;
80104709:	e8 32 f3 ff ff       	call   80103a40 <myproc>
...
8010471c:	5d                   	pop    %ebp
  release(&lk->lk);
8010471d:	e9 2e 02 00 00       	jmp    80104950 <release>
80104722:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
80104729:	00 
...
8010473f:	e8 6c 02 00 00       	call   801049b0 <acquire>
  lk->locked = 0;
...
80104754:	e8 87 fa ff ff       	call   801041e0 <wakeup>
  release(&lk->lk);
...
80104764:	5d                   	pop    %ebp
  release(&lk->lk);
80104765:	e9 e6 01 00 00       	jmp    80104950 <release>
...
80104782:	e8 29 02 00 00       	call   801049b0 <acquire>
...
80104794:	e8 b7 01 00 00       	call   80104950 <release>
  return r;
}
...
801047ab:	e8 90 f2 ff ff       	call   80103a40 <myproc>
...
801047ed:	05 f8 ff ff 7f       	add    $0x7ffffff8,%eax
801047f2:	3d fe ff ff 7f       	cmp    $0x7ffffffe,%eax
  for(i = 0; i < 10; i++){
801047f7:	b8 00 00 00 00       	mov    $0x0,%eax
    if(ebp == 0 || ebp < (uint*)KERNBASE || ebp == (uint*)0xffffffff)
801047fc:	76 10                	jbe    8010480e <getcallerpcs+0x2e>
801047fe:	eb 28                	jmp    80104828 <getcallerpcs+0x48>
...
80104811:	89 1c 81             	mov    %ebx,(%ecx,%eax,4)
  for(i = 0; i < 10; i++){
80104814:	83 c0 01             	add    $0x1,%eax
    ebp = (uint*)ebp[0]; // saved %ebp
80104817:	8b 12                	mov    (%edx),%edx
  for(i = 0; i < 10; i++){
80104819:	83 f8 0a             	cmp    $0xa,%eax
...
80104848:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
  for(; i < 10; i++)
8010484e:	83 c0 08             	add    $0x8,%eax
    pcs[i] = 0;
80104851:	c7 40 fc 00 00 00 00 	movl   $0x0,-0x4(%eax)
  for(; i < 10; i++)
80104858:	39 c1                	cmp    %eax,%ecx
8010485a:	75 ec                	jne    80104848 <getcallerpcs+0x68>
8010485c:	eb c0                	jmp    8010481e <getcallerpcs+0x3e>
...
80104869:	fa                   	cli
  ...
  cli();
  if(mycpu()->ncli == 0)
8010486a:	e8 51 f1 ff ff       	call   801039c0 <mycpu>
8010486f:	8b 80 a4 00 00 00    	mov    0xa4(%eax),%eax
80104875:	85 c0                	test   %eax,%eax
80104877:	74 17                	je     80104890 <pushcli+0x30>
    mycpu()->intena = eflags & FL_IF;
  mycpu()->ncli += 1;
80104879:	e8 42 f1 ff ff       	call   801039c0 <mycpu>
8010487e:	83 80 a4 00 00 00 01 	addl   $0x1,0xa4(%eax)
}
...
8010488a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    mycpu()->intena = eflags & FL_IF;
80104890:	e8 2b f1 ff ff       	call   801039c0 <mycpu>
80104895:	81 e3 00 02 00 00    	and    $0x200,%ebx
8010489b:	89 98 a8 00 00 00    	mov    %ebx,0xa8(%eax)
801048a1:	eb d6                	jmp    80104879 <pushcli+0x19>
...
801048bb:	75 35                	jne    801048f2 <popcli+0x42>
    panic("popcli - interruptible");
  if(--mycpu()->ncli < 0)
801048bd:	e8 fe f0 ff ff       	call   801039c0 <mycpu>
801048c2:	83 a8 a4 00 00 00 01 	subl   $0x1,0xa4(%eax)
801048c9:	78 34                	js     801048ff <popcli+0x4f>
    panic("popcli");
  if(mycpu()->ncli == 0 && mycpu()->intena)
801048cb:	e8 f0 f0 ff ff       	call   801039c0 <mycpu>
801048d0:	8b 90 a4 00 00 00    	mov    0xa4(%eax),%edx
801048d6:	85 d2                	test   %edx,%edx
801048d8:	74 06                	je     801048e0 <popcli+0x30>
    sti();
}
801048da:	c9                   	leave
801048db:	c3                   	ret
801048dc:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  if(mycpu()->ncli == 0 && mycpu()->intena)
801048e0:	e8 db f0 ff ff       	call   801039c0 <mycpu>
801048e5:	8b 80 a8 00 00 00    	mov    0xa8(%eax),%eax
801048eb:	85 c0                	test   %eax,%eax
801048ed:	74 eb                	je     801048da <popcli+0x2a>
  asm volatile("sti");
801048ef:	fb                   	sti
}
801048f0:	c9                   	leave
...
801048f5:	68 73 79 10 80       	push   $0x80107973
801048fa:	e8 81 ba ff ff       	call   80100380 <panic>
    panic("popcli");
801048ff:	83 ec 0c             	sub    $0xc,%esp
80104902:	68 8a 79 10 80       	push   $0x8010798a
80104907:	e8 74 ba ff ff       	call   80100380 <panic>
...
80104918:	31 db                	xor    %ebx,%ebx
  pushcli();
8010491a:	e8 41 ff ff ff       	call   80104860 <pushcli>
  r = lock->locked && lock->cpu == mycpu();
8010491f:	8b 06                	mov    (%esi),%eax
80104921:	85 c0                	test   %eax,%eax
80104923:	75 0b                	jne    80104930 <holding+0x20>
  popcli();
80104925:	e8 86 ff ff ff       	call   801048b0 <popcli>
}
...
8010492f:	c3                   	ret
  r = lock->locked && lock->cpu == mycpu();
80104930:	8b 5e 08             	mov    0x8(%esi),%ebx
80104933:	e8 88 f0 ff ff       	call   801039c0 <mycpu>
80104938:	39 c3                	cmp    %eax,%ebx
8010493a:	0f 94 c3             	sete   %bl
  popcli();
8010493d:	e8 6e ff ff ff       	call   801048b0 <popcli>
  r = lock->locked && lock->cpu == mycpu();
...
80104955:	8b 5d 08             	mov    0x8(%ebp),%ebx
  pushcli();
80104958:	e8 03 ff ff ff       	call   80104860 <pushcli>
  r = lock->locked && lock->cpu == mycpu();
8010495d:	8b 03                	mov    (%ebx),%eax
8010495f:	85 c0                	test   %eax,%eax
80104961:	75 15                	jne    80104978 <release+0x28>
  popcli();
80104963:	e8 48 ff ff ff       	call   801048b0 <popcli>
    panic("release");
80104968:	83 ec 0c             	sub    $0xc,%esp
8010496b:	68 91 79 10 80       	push   $0x80107991
80104970:	e8 0b ba ff ff       	call   80100380 <panic>
80104975:	8d 76 00             	lea    0x0(%esi),%esi
  r = lock->locked && lock->cpu == mycpu();
80104978:	8b 73 08             	mov    0x8(%ebx),%esi
8010497b:	e8 40 f0 ff ff       	call   801039c0 <mycpu>
80104980:	39 c6                	cmp    %eax,%esi
80104982:	75 df                	jne    80104963 <release+0x13>
  popcli();
80104984:	e8 27 ff ff ff       	call   801048b0 <popcli>
  lk->pcs[0] = 0;
80104989:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
  lk->cpu = 0;
80104990:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
  __sync_synchronize();
80104997:	f0 83 0c 24 00       	lock orl $0x0,(%esp)
  asm volatile("movl $0, %0" : "+m" (lk->locked) : );
8010499c:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
}
...
801049a7:	5d                   	pop    %ebp
  popcli();
801049a8:	e9 03 ff ff ff       	jmp    801048b0 <popcli>
...
801049b7:	e8 a4 fe ff ff       	call   80104860 <pushcli>
  if(holding(lk))
801049bc:	8b 5d 08             	mov    0x8(%ebp),%ebx
  pushcli();
801049bf:	e8 9c fe ff ff       	call   80104860 <pushcli>
  r = lock->locked && lock->cpu == mycpu();
801049c4:	8b 03                	mov    (%ebx),%eax
801049c6:	85 c0                	test   %eax,%eax
801049c8:	0f 85 b2 00 00 00    	jne    80104a80 <acquire+0xd0>
  popcli();
801049ce:	e8 dd fe ff ff       	call   801048b0 <popcli>
  asm volatile("lock; xchgl %0, %1" :
801049d3:	b9 01 00 00 00       	mov    $0x1,%ecx
801049d8:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
801049df:	00 
  while(xchg(&lk->locked, 1) != 0)
801049e0:	8b 55 08             	mov    0x8(%ebp),%edx
801049e3:	89 c8                	mov    %ecx,%eax
801049e5:	f0 87 02             	lock xchg %eax,(%edx)
801049e8:	85 c0                	test   %eax,%eax
801049ea:	75 f4                	jne    801049e0 <acquire+0x30>
  __sync_synchronize();
801049ec:	f0 83 0c 24 00       	lock orl $0x0,(%esp)
  lk->cpu = mycpu();
801049f1:	8b 5d 08             	mov    0x8(%ebp),%ebx
801049f4:	e8 c7 ef ff ff       	call   801039c0 <mycpu>
  getcallerpcs(&lk, lk->pcs);
801049f9:	8b 4d 08             	mov    0x8(%ebp),%ecx
  for(i = 0; i < 10; i++){
801049fc:	31 d2                	xor    %edx,%edx
  lk->cpu = mycpu();
801049fe:	89 43 08             	mov    %eax,0x8(%ebx)
    if(ebp == 0 || ebp < (uint*)KERNBASE || ebp == (uint*)0xffffffff)
80104a01:	8d 85 00 00 00 80    	lea    -0x80000000(%ebp),%eax
80104a07:	3d fe ff ff 7f       	cmp    $0x7ffffffe,%eax
80104a0c:	77 32                	ja     80104a40 <acquire+0x90>
  ebp = (uint*)v - 2;
80104a0e:	89 e8                	mov    %ebp,%eax
80104a10:	eb 14                	jmp    80104a26 <acquire+0x76>
...
80104a24:	77 1a                	ja     80104a40 <acquire+0x90>
    pcs[i] = ebp[1];     // saved %eip
80104a26:	8b 58 04             	mov    0x4(%eax),%ebx
80104a29:	89 5c 91 0c          	mov    %ebx,0xc(%ecx,%edx,4)
  for(i = 0; i < 10; i++){
80104a2d:	83 c2 01             	add    $0x1,%edx
    ebp = (uint*)ebp[0]; // saved %ebp
80104a30:	8b 00                	mov    (%eax),%eax
  for(i = 0; i < 10; i++){
80104a32:	83 fa 0a             	cmp    $0xa,%edx
80104a35:	75 e1                	jne    80104a18 <acquire+0x68>
}
80104a37:	8b 5d fc             	mov    -0x4(%ebp),%ebx
80104a3a:	c9                   	leave
80104a3b:	c3                   	ret
80104a3c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80104a40:	8d 44 91 0c          	lea    0xc(%ecx,%edx,4),%eax
80104a44:	83 c1 34             	add    $0x34,%ecx
80104a47:	89 ca                	mov    %ecx,%edx
80104a49:	29 c2                	sub    %eax,%edx
80104a4b:	83 e2 04             	and    $0x4,%edx
80104a4e:	74 10                	je     80104a60 <acquire+0xb0>
    pcs[i] = 0;
80104a50:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
  for(; i < 10; i++)
80104a56:	83 c0 04             	add    $0x4,%eax
80104a59:	39 c1                	cmp    %eax,%ecx
80104a5b:	74 da                	je     80104a37 <acquire+0x87>
...
80104a69:	c7 40 fc 00 00 00 00 	movl   $0x0,-0x4(%eax)
  for(; i < 10; i++)
80104a70:	39 c1                	cmp    %eax,%ecx
80104a72:	75 ec                	jne    80104a60 <acquire+0xb0>
80104a74:	eb c1                	jmp    80104a37 <acquire+0x87>
80104a76:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
80104a7d:	00 
80104a7e:	66 90                	xchg   %ax,%ax
  r = lock->locked && lock->cpu == mycpu();
80104a80:	8b 5b 08             	mov    0x8(%ebx),%ebx
80104a83:	e8 38 ef ff ff       	call   801039c0 <mycpu>
80104a88:	39 c3                	cmp    %eax,%ebx
80104a8a:	0f 85 3e ff ff ff    	jne    801049ce <acquire+0x1e>
  popcli();
80104a90:	e8 1b fe ff ff       	call   801048b0 <popcli>
    panic("acquire");
80104a95:	83 ec 0c             	sub    $0xc,%esp
80104a98:	68 99 79 10 80       	push   $0x80107999
80104a9d:	e8 de b8 ff ff       	call   80100380 <panic>
...
80104aba:	89 d0                	mov    %edx,%eax
80104abc:	09 c8                	or     %ecx,%eax
80104abe:	a8 03                	test   $0x3,%al
80104ac0:	75 1e                	jne    80104ae0 <memset+0x30>
    c &= 0xFF;
80104ac2:	0f b6 45 0c          	movzbl 0xc(%ebp),%eax
    stosl(dst, (c<<24)|(c<<16)|(c<<8)|c, n/4);
80104ac6:	c1 e9 02             	shr    $0x2,%ecx
  asm volatile("cld; rep stosl" :
80104ac9:	89 d7                	mov    %edx,%edi
80104acb:	69 c0 01 01 01 01    	imul   $0x1010101,%eax,%eax
80104ad1:	fc                   	cld
80104ad2:	f3 ab                	rep stos %eax,%es:(%edi)
  } else
    stosb(dst, c, n);
  return dst;
}
80104ad4:	8b 7d fc             	mov    -0x4(%ebp),%edi
80104ad7:	89 d0                	mov    %edx,%eax
80104ad9:	c9                   	leave
80104ada:	c3                   	ret
...
80104ae5:	fc                   	cld
80104ae6:	f3 aa                	rep stos %al,%es:(%edi)
80104ae8:	8b 7d fc             	mov    -0x4(%ebp),%edi
80104aeb:	89 d0                	mov    %edx,%eax
80104aed:	c9                   	leave
80104aee:	c3                   	ret
80104aef:	90                   	nop
...
80104b1d:	0f b6 1a             	movzbl (%edx),%ebx
...
80104b47:	8b 45 10             	mov    0x10(%ebp),%eax
...
80104b52:	8d 0c 06             	lea    (%esi,%eax,1),%ecx
80104b55:	39 ca                	cmp    %ecx,%edx
80104b57:	73 1f                	jae    80104b78 <memmove+0x38>
    s += n;
    d += n;
    while(n-- > 0)
80104b59:	85 c0                	test   %eax,%eax
80104b5b:	74 0f                	je     80104b6c <memmove+0x2c>
80104b5d:	83 e8 01             	sub    $0x1,%eax
      *--d = *--s;
...
80104b72:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    while(n-- > 0)
80104b78:	8d 0c 06             	lea    (%esi,%eax,1),%ecx
...
80104b91:	5d                   	pop    %ebp
80104b92:	c3                   	ret
80104b93:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
80104b9a:	00 
...
80104bba:	8b 4d 0c             	mov    0xc(%ebp),%ecx
  while(n > 0 && *p && *p == *q)
80104bbd:	85 d2                	test   %edx,%edx
80104bbf:	75 16                	jne    80104bd7 <strncmp+0x27>
80104bc1:	eb 2d                	jmp    80104bf0 <strncmp+0x40>
80104bc3:	2e 8d 74 26 00       	lea    %cs:0x0(%esi,%eiz,1),%esi
80104bc8:	3a 19                	cmp    (%ecx),%bl
80104bca:	75 12                	jne    80104bde <strncmp+0x2e>
    n--, p++, q++;
80104bcc:	83 c0 01             	add    $0x1,%eax
80104bcf:	83 c1 01             	add    $0x1,%ecx
  while(n > 0 && *p && *p == *q)
80104bd2:	83 ea 01             	sub    $0x1,%edx
80104bd5:	74 19                	je     80104bf0 <strncmp+0x40>
80104bd7:	0f b6 18             	movzbl (%eax),%ebx
80104bda:	84 db                	test   %bl,%bl
80104bdc:	75 ea                	jne    80104bc8 <strncmp+0x18>
  if(n == 0)
    return 0;
  return (uchar)*p - (uchar)*q;
80104bde:	0f b6 00             	movzbl (%eax),%eax
80104be1:	0f b6 11             	movzbl (%ecx),%edx
}
80104be4:	8b 5d fc             	mov    -0x4(%ebp),%ebx
80104be7:	c9                   	leave
  return (uchar)*p - (uchar)*q;
80104be8:	29 d0                	sub    %edx,%eax
}
80104bea:	c3                   	ret
...
80104c09:	8b 55 10             	mov    0x10(%ebp),%edx
  char *os;
...
80104c1a:	0f b6 4f ff          	movzbl -0x1(%edi),%ecx
80104c1e:	88 48 ff             	mov    %cl,-0x1(%eax)
80104c21:	84 c9                	test   %cl,%cl
80104c23:	74 13                	je     80104c38 <strncpy+0x38>
...
80104c35:	8d 76 00             	lea    0x0(%esi),%esi
  while(n-- > 0)
80104c38:	8d 0c 18             	lea    (%eax,%ebx,1),%ecx
80104c3b:	83 e9 01             	sub    $0x1,%ecx
80104c3e:	85 d2                	test   %edx,%edx
80104c40:	74 ec                	je     80104c2e <strncpy+0x2e>
80104c42:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    *s++ = 0;
80104c48:	83 c0 01             	add    $0x1,%eax
80104c4b:	89 ca                	mov    %ecx,%edx
80104c4d:	c6 40 ff 00          	movb   $0x0,-0x1(%eax)
  while(n-- > 0)
80104c51:	29 c2                	sub    %eax,%edx
80104c53:	85 d2                	test   %edx,%edx
80104c55:	7f f1                	jg     80104c48 <strncpy+0x48>
}
80104c57:	5b                   	pop    %ebx
80104c58:	89 f0                	mov    %esi,%eax
80104c5a:	5e                   	pop    %esi
80104c5b:	5f                   	pop    %edi
80104c5c:	5d                   	pop    %ebp
80104c5d:	c3                   	ret
...
80104cd7:	8b 5d 08             	mov    0x8(%ebp),%ebx
  struct proc *curproc = myproc();
80104cda:	e8 61 ed ff ff       	call   80103a40 <myproc>

  if(addr >= curproc->sz || addr+4 > curproc->sz)
80104cdf:	8b 00                	mov    (%eax),%eax
80104ce1:	39 c3                	cmp    %eax,%ebx
80104ce3:	73 1b                	jae    80104d00 <fetchint+0x30>
...
80104d17:	8b 5d 08             	mov    0x8(%ebp),%ebx
  char *s, *ep;
  struct proc *curproc = myproc();
80104d1a:	e8 21 ed ff ff       	call   80103a40 <myproc>

  if(addr >= curproc->sz)
80104d1f:	3b 18                	cmp    (%eax),%ebx
80104d21:	73 2d                	jae    80104d50 <fetchstr+0x40>
    return -1;
  *pp = (char*)addr;
...
80104d3b:	39 d0                	cmp    %edx,%eax
80104d3d:	73 11                	jae    80104d50 <fetchstr+0x40>
    if(*s == 0)
...
80104d65:	e8 d6 ec ff ff       	call   80103a40 <myproc>
...
80104d73:	8d 1c 90             	lea    (%eax,%edx,4),%ebx
  struct proc *curproc = myproc();
80104d76:	e8 c5 ec ff ff       	call   80103a40 <myproc>
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
...
80104db6:	83 ec 0c             	sub    $0xc,%esp
  int i;
  struct proc *curproc = myproc();
80104db9:	e8 82 ec ff ff       	call   80103a40 <myproc>
80104dbe:	89 c6                	mov    %eax,%esi
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
80104dc0:	e8 7b ec ff ff       	call   80103a40 <myproc>
80104dc5:	8b 55 08             	mov    0x8(%ebp),%edx
80104dc8:	8b 40 18             	mov    0x18(%eax),%eax
80104dcb:	8b 40 44             	mov    0x44(%eax),%eax
80104dce:	8d 1c 90             	lea    (%eax,%edx,4),%ebx
  struct proc *curproc = myproc();
80104dd1:	e8 6a ec ff ff       	call   80103a40 <myproc>
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
...
80104df2:	39 d0                	cmp    %edx,%eax
80104df4:	73 1a                	jae    80104e10 <argptr+0x60>
...
80104e24:	53                   	push   %ebx
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
80104e25:	e8 16 ec ff ff       	call   80103a40 <myproc>
...
80104e33:	8d 1c 90             	lea    (%eax,%edx,4),%ebx
  struct proc *curproc = myproc();
80104e36:	e8 05 ec ff ff       	call   80103a40 <myproc>
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
...
80104e4b:	8b 5b 04             	mov    0x4(%ebx),%ebx
  struct proc *curproc = myproc();
80104e4e:	e8 ed eb ff ff       	call   80103a40 <myproc>
  if(addr >= curproc->sz)
...
80104e75:	73 11                	jae    80104e88 <argstr+0x68>
    if(*s == 0)
...
80104e8f:	5d                   	pop    %ebp
80104e90:	c3                   	ret
80104e91:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
80104e98:	00 
...
80104ea4:	83 ec 04             	sub    $0x4,%esp
  int num;
  struct proc *curproc = myproc();
80104ea7:	e8 94 eb ff ff       	call   80103a40 <myproc>
...
80104ee0:	50                   	push   %eax
            curproc->pid, curproc->name, num);
80104ee1:	8d 43 6c             	lea    0x6c(%ebx),%eax
    cprintf("%d %s: unknown sys call %d\n",
80104ee4:	50                   	push   %eax
80104ee5:	ff 73 10             	push   0x10(%ebx)
80104ee8:	68 a1 79 10 80       	push   $0x801079a1
80104eed:	e8 be b7 ff ff       	call   801006b0 <cprintf>
    curproc->tf->eax = -1;
80104ef2:	8b 43 18             	mov    0x18(%ebx),%eax
...
80104f22:	89 55 d4             	mov    %edx,-0x2c(%ebp)
80104f25:	89 4d cc             	mov    %ecx,-0x34(%ebp)
  if((dp = nameiparent(path, name)) == 0)
80104f28:	57                   	push   %edi
80104f29:	50                   	push   %eax
80104f2a:	e8 71 d1 ff ff       	call   801020a0 <nameiparent>
80104f2f:	83 c4 10             	add    $0x10,%esp
80104f32:	85 c0                	test   %eax,%eax
80104f34:	74 5e                	je     80104f94 <create+0x84>
    return 0;
  ilock(dp);
80104f36:	83 ec 0c             	sub    $0xc,%esp
80104f39:	89 c3                	mov    %eax,%ebx
80104f3b:	50                   	push   %eax
80104f3c:	e8 5f c8 ff ff       	call   801017a0 <ilock>
...
80104f48:	e8 a3 cd ff ff       	call   80101cf0 <dirlookup>
80104f4d:	83 c4 10             	add    $0x10,%esp
80104f50:	89 c6                	mov    %eax,%esi
80104f52:	85 c0                	test   %eax,%eax
80104f54:	74 4a                	je     80104fa0 <create+0x90>
    iunlockput(dp);
80104f56:	83 ec 0c             	sub    $0xc,%esp
80104f59:	53                   	push   %ebx
80104f5a:	e8 d1 ca ff ff       	call   80101a30 <iunlockput>
    ilock(ip);
80104f5f:	89 34 24             	mov    %esi,(%esp)
80104f62:	e8 39 c8 ff ff       	call   801017a0 <ilock>
    if(type == T_FILE && ip->type == T_FILE)
80104f67:	83 c4 10             	add    $0x10,%esp
80104f6a:	66 83 7d d4 02       	cmpw   $0x2,-0x2c(%ebp)
80104f6f:	75 17                	jne    80104f88 <create+0x78>
80104f71:	66 83 7e 50 02       	cmpw   $0x2,0x50(%esi)
80104f76:	75 10                	jne    80104f88 <create+0x78>
...
80104f8c:	e8 9f ca ff ff       	call   80101a30 <iunlockput>
    return 0;
80104f91:	83 c4 10             	add    $0x10,%esp
}
80104f94:	8d 65 f4             	lea    -0xc(%ebp),%esp
    return 0;
80104f97:	31 f6                	xor    %esi,%esi
}
80104f99:	5b                   	pop    %ebx
80104f9a:	89 f0                	mov    %esi,%eax
80104f9c:	5e                   	pop    %esi
80104f9d:	5f                   	pop    %edi
80104f9e:	5d                   	pop    %ebp
80104f9f:	c3                   	ret
...
80104fa8:	ff 33                	push   (%ebx)
80104faa:	e8 81 c6 ff ff       	call   80101630 <ialloc>
80104faf:	83 c4 10             	add    $0x10,%esp
80104fb2:	89 c6                	mov    %eax,%esi
80104fb4:	85 c0                	test   %eax,%eax
80104fb6:	0f 84 bc 00 00 00    	je     80105078 <create+0x168>
  ilock(ip);
80104fbc:	83 ec 0c             	sub    $0xc,%esp
80104fbf:	50                   	push   %eax
80104fc0:	e8 db c7 ff ff       	call   801017a0 <ilock>
  ip->major = major;
...
80105029:	e8 c2 c6 ff ff       	call   801016f0 <iupdate>
    if(dirlink(ip, ".", ip->inum) < 0 || dirlink(ip, "..", dp->inum) < 0)
8010502e:	83 c4 0c             	add    $0xc,%esp
80105031:	ff 76 04             	push   0x4(%esi)
80105034:	68 d9 79 10 80       	push   $0x801079d9
80105039:	56                   	push   %esi
8010503a:	e8 81 cf ff ff       	call   80101fc0 <dirlink>
8010503f:	83 c4 10             	add    $0x10,%esp
80105042:	85 c0                	test   %eax,%eax
80105044:	78 18                	js     8010505e <create+0x14e>
80105046:	83 ec 04             	sub    $0x4,%esp
80105049:	ff 73 04             	push   0x4(%ebx)
8010504c:	68 d8 79 10 80       	push   $0x801079d8
80105051:	56                   	push   %esi
80105052:	e8 69 cf ff ff       	call   80101fc0 <dirlink>
80105057:	83 c4 10             	add    $0x10,%esp
8010505a:	85 c0                	test   %eax,%eax
8010505c:	79 92                	jns    80104ff0 <create+0xe0>
      panic("create dots");
8010505e:	83 ec 0c             	sub    $0xc,%esp
80105061:	68 cc 79 10 80       	push   $0x801079cc
80105066:	e8 15 b3 ff ff       	call   80100380 <panic>
    panic("create: dirlink");
8010506b:	83 ec 0c             	sub    $0xc,%esp
8010506e:	68 db 79 10 80       	push   $0x801079db
80105073:	e8 08 b3 ff ff       	call   80100380 <panic>
    panic("create: ialloc");
80105078:	83 ec 0c             	sub    $0xc,%esp
8010507b:	68 bd 79 10 80       	push   $0x801079bd
80105080:	e8 fb b2 ff ff       	call   80100380 <panic>
80105085:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
8010508c:	00 
...
8010509e:	e8 bd fc ff ff       	call   80104d60 <argint>
801050a3:	83 c4 10             	add    $0x10,%esp
801050a6:	85 c0                	test   %eax,%eax
801050a8:	78 36                	js     801050e0 <sys_dup+0x50>
  if(fd < 0 || fd >= NOFILE || (f=myproc()->ofile[fd]) == 0)
801050aa:	83 7d f4 0f          	cmpl   $0xf,-0xc(%ebp)
801050ae:	77 30                	ja     801050e0 <sys_dup+0x50>
...
801050be:	74 20                	je     801050e0 <sys_dup+0x50>
  struct proc *curproc = myproc();
801050c0:	e8 7b e9 ff ff       	call   80103a40 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
801050c5:	31 db                	xor    %ebx,%ebx
...
801050d6:	74 18                	je     801050f0 <sys_dup+0x60>
  for(fd = 0; fd < NOFILE; fd++){
801050d8:	83 c3 01             	add    $0x1,%ebx
801050db:	83 fb 10             	cmp    $0x10,%ebx
801050de:	75 f0                	jne    801050d0 <sys_dup+0x40>
}
...
801050f0:	83 ec 0c             	sub    $0xc,%esp
      curproc->ofile[fd] = f;
801050f3:	89 74 98 28          	mov    %esi,0x28(%eax,%ebx,4)
  filedup(f);
801050f7:	56                   	push   %esi
801050f8:	e8 c3 bd ff ff       	call   80100ec0 <filedup>
  return fd;
801050fd:	83 c4 10             	add    $0x10,%esp
}
80105100:	8d 65 f8             	lea    -0x8(%ebp),%esp
80105103:	89 d8                	mov    %ebx,%eax
80105105:	5b                   	pop    %ebx
80105106:	5e                   	pop    %esi
80105107:	5d                   	pop    %ebp
80105108:	c3                   	ret
...
8010518d:	eb ed                	jmp    8010517c <sys_read+0x6c>
8010518f:	90                   	nop
...
80105201:	5d                   	pop    %ebp
80105202:	c3                   	ret
80105203:	2e 8d 74 26 00       	lea    %cs:0x0(%esi,%eiz,1),%esi
    return -1;
80105208:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010520d:	eb ed                	jmp    801051fc <sys_write+0x6c>
8010520f:	90                   	nop
...
8010521e:	e8 3d fb ff ff       	call   80104d60 <argint>
80105223:	83 c4 10             	add    $0x10,%esp
80105226:	85 c0                	test   %eax,%eax
80105228:	78 3e                	js     80105268 <sys_close+0x58>
  if(fd < 0 || fd >= NOFILE || (f=myproc()->ofile[fd]) == 0)
8010522a:	83 7d f4 0f          	cmpl   $0xf,-0xc(%ebp)
8010522e:	77 38                	ja     80105268 <sys_close+0x58>
80105230:	e8 0b e8 ff ff       	call   80103a40 <myproc>
80105235:	8b 55 f4             	mov    -0xc(%ebp),%edx
80105238:	8d 5a 08             	lea    0x8(%edx),%ebx
8010523b:	8b 74 98 08          	mov    0x8(%eax,%ebx,4),%esi
8010523f:	85 f6                	test   %esi,%esi
80105241:	74 25                	je     80105268 <sys_close+0x58>
  myproc()->ofile[fd] = 0;
80105243:	e8 f8 e7 ff ff       	call   80103a40 <myproc>
  fileclose(f);
80105248:	83 ec 0c             	sub    $0xc,%esp
  myproc()->ofile[fd] = 0;
8010524b:	c7 44 98 08 00 00 00 	movl   $0x0,0x8(%eax,%ebx,4)
80105252:	00 
  fileclose(f);
80105253:	56                   	push   %esi
80105254:	e8 b7 bc ff ff       	call   80100f10 <fileclose>
  return 0;
...
8010526d:	eb ef                	jmp    8010525e <sys_close+0x4e>
8010526f:	90                   	nop
...
801052d5:	eb ec                	jmp    801052c3 <sys_fstat+0x53>
...
801052e5:	8d 45 d4             	lea    -0x2c(%ebp),%eax
{
...
801052ef:	e8 2c fb ff ff       	call   80104e20 <argstr>
...
80105302:	8d 45 d0             	lea    -0x30(%ebp),%eax
80105305:	50                   	push   %eax
80105306:	6a 01                	push   $0x1
80105308:	e8 13 fb ff ff       	call   80104e20 <argstr>
8010530d:	83 c4 10             	add    $0x10,%esp
80105310:	85 c0                	test   %eax,%eax
80105312:	0f 88 e2 00 00 00    	js     801053fa <sys_link+0x11a>
  begin_op();
80105318:	e8 23 da ff ff       	call   80102d40 <begin_op>
  if((ip = namei(old)) == 0){
8010531d:	83 ec 0c             	sub    $0xc,%esp
80105320:	ff 75 d4             	push   -0x2c(%ebp)
80105323:	e8 58 cd ff ff       	call   80102080 <namei>
80105328:	83 c4 10             	add    $0x10,%esp
8010532b:	89 c3                	mov    %eax,%ebx
8010532d:	85 c0                	test   %eax,%eax
8010532f:	0f 84 df 00 00 00    	je     80105414 <sys_link+0x134>
  ilock(ip);
80105335:	83 ec 0c             	sub    $0xc,%esp
80105338:	50                   	push   %eax
80105339:	e8 62 c4 ff ff       	call   801017a0 <ilock>
  if(ip->type == T_DIR){
8010533e:	83 c4 10             	add    $0x10,%esp
80105341:	66 83 7b 50 01       	cmpw   $0x1,0x50(%ebx)
80105346:	0f 84 b5 00 00 00    	je     80105401 <sys_link+0x121>
  iupdate(ip);
8010534c:	83 ec 0c             	sub    $0xc,%esp
  ip->nlink++;
8010534f:	66 83 43 56 01       	addw   $0x1,0x56(%ebx)
  if((dp = nameiparent(new, name)) == 0)
80105354:	8d 7d da             	lea    -0x26(%ebp),%edi
  iupdate(ip);
80105357:	53                   	push   %ebx
80105358:	e8 93 c3 ff ff       	call   801016f0 <iupdate>
  iunlock(ip);
8010535d:	89 1c 24             	mov    %ebx,(%esp)
80105360:	e8 1b c5 ff ff       	call   80101880 <iunlock>
  if((dp = nameiparent(new, name)) == 0)
80105365:	58                   	pop    %eax
80105366:	5a                   	pop    %edx
80105367:	57                   	push   %edi
80105368:	ff 75 d0             	push   -0x30(%ebp)
8010536b:	e8 30 cd ff ff       	call   801020a0 <nameiparent>
80105370:	83 c4 10             	add    $0x10,%esp
80105373:	89 c6                	mov    %eax,%esi
...
8010538e:	ff 73 04             	push   0x4(%ebx)
80105391:	57                   	push   %edi
80105392:	56                   	push   %esi
80105393:	e8 28 cc ff ff       	call   80101fc0 <dirlink>
...
801053a3:	e8 88 c6 ff ff       	call   80101a30 <iunlockput>
  iput(ip);
801053a8:	89 1c 24             	mov    %ebx,(%esp)
801053ab:	e8 20 c5 ff ff       	call   801018d0 <iput>
  end_op();
...
801053cc:	e8 5f c6 ff ff       	call   80101a30 <iunlockput>
    goto bad;
...
801053e5:	e8 06 c3 ff ff       	call   801016f0 <iupdate>
  iunlockput(ip);
801053ea:	89 1c 24             	mov    %ebx,(%esp)
801053ed:	e8 3e c6 ff ff       	call   80101a30 <iunlockput>
  end_op();
801053f2:	e8 b9 d9 ff ff       	call   80102db0 <end_op>
  return -1;
801053f7:	83 c4 10             	add    $0x10,%esp
    return -1;
801053fa:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801053ff:	eb b9                	jmp    801053ba <sys_link+0xda>
    iunlockput(ip);
80105401:	83 ec 0c             	sub    $0xc,%esp
80105404:	53                   	push   %ebx
80105405:	e8 26 c6 ff ff       	call   80101a30 <iunlockput>
    end_op();
8010540a:	e8 a1 d9 ff ff       	call   80102db0 <end_op>
    return -1;
8010540f:	83 c4 10             	add    $0x10,%esp
80105412:	eb e6                	jmp    801053fa <sys_link+0x11a>
    end_op();
80105414:	e8 97 d9 ff ff       	call   80102db0 <end_op>
    return -1;
80105419:	eb df                	jmp    801053fa <sys_link+0x11a>
...
80105424:	56                   	push   %esi
  if(argstr(0, &path) < 0)
80105425:	8d 45 c0             	lea    -0x40(%ebp),%eax
{
...
8010542f:	e8 ec f9 ff ff       	call   80104e20 <argstr>
80105434:	83 c4 10             	add    $0x10,%esp
80105437:	85 c0                	test   %eax,%eax
80105439:	0f 88 54 01 00 00    	js     80105593 <sys_unlink+0x173>
  begin_op();
8010543f:	e8 fc d8 ff ff       	call   80102d40 <begin_op>
  if((dp = nameiparent(path, name)) == 0){
80105444:	8d 5d ca             	lea    -0x36(%ebp),%ebx
80105447:	83 ec 08             	sub    $0x8,%esp
8010544a:	53                   	push   %ebx
8010544b:	ff 75 c0             	push   -0x40(%ebp)
8010544e:	e8 4d cc ff ff       	call   801020a0 <nameiparent>
80105453:	83 c4 10             	add    $0x10,%esp
80105456:	89 45 b4             	mov    %eax,-0x4c(%ebp)
80105459:	85 c0                	test   %eax,%eax
8010545b:	0f 84 58 01 00 00    	je     801055b9 <sys_unlink+0x199>
  ilock(dp);
80105461:	8b 7d b4             	mov    -0x4c(%ebp),%edi
80105464:	83 ec 0c             	sub    $0xc,%esp
80105467:	57                   	push   %edi
80105468:	e8 33 c3 ff ff       	call   801017a0 <ilock>
  if(namecmp(name, ".") == 0 || namecmp(name, "..") == 0)
8010546d:	58                   	pop    %eax
8010546e:	5a                   	pop    %edx
8010546f:	68 d9 79 10 80       	push   $0x801079d9
80105474:	53                   	push   %ebx
80105475:	e8 56 c8 ff ff       	call   80101cd0 <namecmp>
8010547a:	83 c4 10             	add    $0x10,%esp
8010547d:	85 c0                	test   %eax,%eax
8010547f:	0f 84 fb 00 00 00    	je     80105580 <sys_unlink+0x160>
80105485:	83 ec 08             	sub    $0x8,%esp
80105488:	68 d8 79 10 80       	push   $0x801079d8
8010548d:	53                   	push   %ebx
8010548e:	e8 3d c8 ff ff       	call   80101cd0 <namecmp>
80105493:	83 c4 10             	add    $0x10,%esp
80105496:	85 c0                	test   %eax,%eax
80105498:	0f 84 e2 00 00 00    	je     80105580 <sys_unlink+0x160>
  if((ip = dirlookup(dp, name, &off)) == 0)
8010549e:	83 ec 04             	sub    $0x4,%esp
801054a1:	8d 45 c4             	lea    -0x3c(%ebp),%eax
801054a4:	50                   	push   %eax
801054a5:	53                   	push   %ebx
801054a6:	57                   	push   %edi
801054a7:	e8 44 c8 ff ff       	call   80101cf0 <dirlookup>
801054ac:	83 c4 10             	add    $0x10,%esp
801054af:	89 c3                	mov    %eax,%ebx
801054b1:	85 c0                	test   %eax,%eax
801054b3:	0f 84 c7 00 00 00    	je     80105580 <sys_unlink+0x160>
  ilock(ip);
801054b9:	83 ec 0c             	sub    $0xc,%esp
801054bc:	50                   	push   %eax
801054bd:	e8 de c2 ff ff       	call   801017a0 <ilock>
  if(ip->nlink < 1)
801054c2:	83 c4 10             	add    $0x10,%esp
801054c5:	66 83 7b 56 00       	cmpw   $0x0,0x56(%ebx)
801054ca:	0f 8e 0a 01 00 00    	jle    801055da <sys_unlink+0x1ba>
  if(ip->type == T_DIR && !isdirempty(ip)){
801054d0:	66 83 7b 50 01       	cmpw   $0x1,0x50(%ebx)
801054d5:	8d 7d d8             	lea    -0x28(%ebp),%edi
...
801054e2:	e8 c9 f5 ff ff       	call   80104ab0 <memset>
  if(writei(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
801054e7:	6a 10                	push   $0x10
801054e9:	ff 75 c4             	push   -0x3c(%ebp)
801054ec:	57                   	push   %edi
801054ed:	ff 75 b4             	push   -0x4c(%ebp)
801054f0:	e8 bb c6 ff ff       	call   80101bb0 <writei>
801054f5:	83 c4 20             	add    $0x20,%esp
801054f8:	83 f8 10             	cmp    $0x10,%eax
801054fb:	0f 85 cc 00 00 00    	jne    801055cd <sys_unlink+0x1ad>
  if(ip->type == T_DIR){
80105501:	66 83 7b 50 01       	cmpw   $0x1,0x50(%ebx)
80105506:	0f 84 94 00 00 00    	je     801055a0 <sys_unlink+0x180>
  iunlockput(dp);
8010550c:	83 ec 0c             	sub    $0xc,%esp
8010550f:	ff 75 b4             	push   -0x4c(%ebp)
80105512:	e8 19 c5 ff ff       	call   80101a30 <iunlockput>
  ip->nlink--;
80105517:	66 83 6b 56 01       	subw   $0x1,0x56(%ebx)
  iupdate(ip);
8010551c:	89 1c 24             	mov    %ebx,(%esp)
8010551f:	e8 cc c1 ff ff       	call   801016f0 <iupdate>
  iunlockput(ip);
80105524:	89 1c 24             	mov    %ebx,(%esp)
80105527:	e8 04 c5 ff ff       	call   80101a30 <iunlockput>
  end_op();
8010552c:	e8 7f d8 ff ff       	call   80102db0 <end_op>
  return 0;
...
80105546:	be 20 00 00 00       	mov    $0x20,%esi
8010554b:	eb 0b                	jmp    80105558 <sys_unlink+0x138>
8010554d:	8d 76 00             	lea    0x0(%esi),%esi
80105550:	83 c6 10             	add    $0x10,%esi
80105553:	3b 73 58             	cmp    0x58(%ebx),%esi
80105556:	73 82                	jae    801054da <sys_unlink+0xba>
    if(readi(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
80105558:	6a 10                	push   $0x10
8010555a:	56                   	push   %esi
8010555b:	57                   	push   %edi
8010555c:	53                   	push   %ebx
8010555d:	e8 4e c5 ff ff       	call   80101ab0 <readi>
80105562:	83 c4 10             	add    $0x10,%esp
80105565:	83 f8 10             	cmp    $0x10,%eax
80105568:	75 56                	jne    801055c0 <sys_unlink+0x1a0>
    if(de.inum != 0)
8010556a:	66 83 7d d8 00       	cmpw   $0x0,-0x28(%ebp)
8010556f:	74 df                	je     80105550 <sys_unlink+0x130>
    iunlockput(ip);
80105571:	83 ec 0c             	sub    $0xc,%esp
80105574:	53                   	push   %ebx
80105575:	e8 b6 c4 ff ff       	call   80101a30 <iunlockput>
    goto bad;
8010557a:	83 c4 10             	add    $0x10,%esp
8010557d:	8d 76 00             	lea    0x0(%esi),%esi
  iunlockput(dp);
80105580:	83 ec 0c             	sub    $0xc,%esp
80105583:	ff 75 b4             	push   -0x4c(%ebp)
80105586:	e8 a5 c4 ff ff       	call   80101a30 <iunlockput>
  end_op();
8010558b:	e8 20 d8 ff ff       	call   80102db0 <end_op>
  return -1;
80105590:	83 c4 10             	add    $0x10,%esp
    return -1;
80105593:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105598:	eb 9c                	jmp    80105536 <sys_unlink+0x116>
8010559a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    dp->nlink--;
801055a0:	8b 45 b4             	mov    -0x4c(%ebp),%eax
    iupdate(dp);
801055a3:	83 ec 0c             	sub    $0xc,%esp
    dp->nlink--;
801055a6:	66 83 68 56 01       	subw   $0x1,0x56(%eax)
    iupdate(dp);
801055ab:	50                   	push   %eax
801055ac:	e8 3f c1 ff ff       	call   801016f0 <iupdate>
801055b1:	83 c4 10             	add    $0x10,%esp
801055b4:	e9 53 ff ff ff       	jmp    8010550c <sys_unlink+0xec>
    end_op();
801055b9:	e8 f2 d7 ff ff       	call   80102db0 <end_op>
    return -1;
801055be:	eb d3                	jmp    80105593 <sys_unlink+0x173>
      panic("isdirempty: readi");
801055c0:	83 ec 0c             	sub    $0xc,%esp
801055c3:	68 fd 79 10 80       	push   $0x801079fd
801055c8:	e8 b3 ad ff ff       	call   80100380 <panic>
    panic("unlink: writei");
801055cd:	83 ec 0c             	sub    $0xc,%esp
801055d0:	68 0f 7a 10 80       	push   $0x80107a0f
801055d5:	e8 a6 ad ff ff       	call   80100380 <panic>
    panic("unlink: nlink < 1");
801055da:	83 ec 0c             	sub    $0xc,%esp
801055dd:	68 eb 79 10 80       	push   $0x801079eb
801055e2:	e8 99 ad ff ff       	call   80100380 <panic>
...
801055ff:	e8 1c f8 ff ff       	call   80104e20 <argstr>
...
80105618:	e8 43 f7 ff ff       	call   80104d60 <argint>
...
80105622:	78 79                	js     8010569d <sys_open+0xad>
  ...
  begin_op();
80105624:	e8 17 d7 ff ff       	call   80102d40 <begin_op>
...
80105635:	e8 46 ca ff ff       	call   80102080 <namei>
...
8010564b:	e8 50 c1 ff ff       	call   801017a0 <ilock>
    if(ip->type == T_DIR && omode != O_RDONLY){
80105650:	83 c4 10             	add    $0x10,%esp
80105653:	66 83 7e 50 01       	cmpw   $0x1,0x50(%esi)
80105658:	0f 84 ba 00 00 00    	je     80105718 <sys_open+0x128>
      end_op();
      return -1;
    }
  }
...
80105690:	e8 9b c3 ff ff       	call   80101a30 <iunlockput>
    end_op();
80105695:	e8 16 d7 ff ff       	call   80102db0 <end_op>
    return -1;
8010569a:	83 c4 10             	add    $0x10,%esp
    return -1;
8010569d:	bb ff ff ff ff       	mov    $0xffffffff,%ebx
801056a2:	eb 65                	jmp    80105709 <sys_open+0x119>
801056a4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    ip = create(path, T_FILE, 0, 0);
801056a8:	83 ec 0c             	sub    $0xc,%esp
801056ab:	31 c9                	xor    %ecx,%ecx
801056ad:	ba 02 00 00 00       	mov    $0x2,%edx
801056b2:	6a 00                	push   $0x0
801056b4:	8b 45 e0             	mov    -0x20(%ebp),%eax
801056b7:	e8 54 f8 ff ff       	call   80104f10 <create>
    if(ip == 0){
...
801056c5:	e8 e6 d6 ff ff       	call   80102db0 <end_op>
      return -1;
801056ca:	eb d1                	jmp    8010569d <sys_open+0xad>
...
801056d8:	e8 a3 c1 ff ff       	call   80101880 <iunlock>
  end_op();
801056dd:	e8 ce d6 ff ff       	call   80102db0 <end_op>
...
801056f1:	89 d0                	mov    %edx,%eax
  f->off = 0;
801056f3:	c7 47 14 00 00 00 00 	movl   $0x0,0x14(%edi)
  f->readable = !(omode & O_WRONLY);
801056fa:	f7 d0                	not    %eax
801056fc:	83 e0 01             	and    $0x1,%eax
  f->writable = (omode & O_WRONLY) || (omode & O_RDWR);
801056ff:	83 e2 03             	and    $0x3,%edx
  f->readable = !(omode & O_WRONLY);
80105702:	88 47 08             	mov    %al,0x8(%edi)
  f->writable = (omode & O_WRONLY) || (omode & O_RDWR);
80105705:	0f 95 47 09          	setne  0x9(%edi)
  return fd;
}
80105709:	8d 65 f4             	lea    -0xc(%ebp),%esp
8010570c:	89 d8                	mov    %ebx,%eax
8010570e:	5b                   	pop    %ebx
8010570f:	5e                   	pop    %esi
80105710:	5f                   	pop    %edi
80105711:	5d                   	pop    %ebp
...
8010571d:	0f 84 3b ff ff ff    	je     8010565e <sys_open+0x6e>
80105723:	e9 64 ff ff ff       	jmp    8010568c <sys_open+0x9c>
...
8010575f:	e8 ac f7 ff ff       	call   80104f10 <create>
...
8010576f:	e8 bc c2 ff ff       	call   80101a30 <iunlockput>
  end_op();
80105774:	e8 37 d6 ff ff       	call   80102db0 <end_op>
  return 0;
...
80105793:	83 ec 18             	sub    $0x18,%esp
  ...
  begin_op();
80105796:	e8 a5 d5 ff ff       	call   80102d40 <begin_op>
  if((argstr(0, &path)) < 0 ||
...
801057b9:	e8 a2 f5 ff ff       	call   80104d60 <argint>
  if((argstr(0, &path)) < 0 ||
...
801057ce:	e8 8d f5 ff ff       	call   80104d60 <argint>
     argint(1, &major) < 0 ||
...
801057ee:	e8 1d f7 ff ff       	call   80104f10 <create>
     argint(2, &minor) < 0 ||
...
801057fe:	e8 2d c2 ff ff       	call   80101a30 <iunlockput>
  end_op();
80105803:	e8 a8 d5 ff ff       	call   80102db0 <end_op>
  return 0;
...
80105825:	83 ec 10             	sub    $0x10,%esp
  ...
  struct inode *ip;
  struct proc *curproc = myproc();
80105828:	e8 13 e2 ff ff       	call   80103a40 <myproc>
8010582d:	89 c6                	mov    %eax,%esi
  
  begin_op();
8010582f:	e8 0c d5 ff ff       	call   80102d40 <begin_op>
...
8010584f:	e8 2c c8 ff ff       	call   80102080 <namei>
...
80105861:	e8 3a bf ff ff       	call   801017a0 <ilock>
  if(ip->type != T_DIR){
...
80105874:	e8 07 c0 ff ff       	call   80101880 <iunlock>
  iput(curproc->cwd);
80105879:	58                   	pop    %eax
8010587a:	ff 76 68             	push   0x68(%esi)
8010587d:	e8 4e c0 ff ff       	call   801018d0 <iput>
  end_op();
80105882:	e8 29 d5 ff ff       	call   80102db0 <end_op>
  curproc->cwd = ip;
...
801058a4:	e8 87 c1 ff ff       	call   80101a30 <iunlockput>
    end_op();
...
801058c0:	e8 eb d4 ff ff       	call   80102db0 <end_op>
    return -1;
801058c5:	eb ea                	jmp    801058b1 <sys_chdir+0x91>
...
80105901:	e8 5a f4 ff ff       	call   80104d60 <argint>
...
80105920:	e8 8b f1 ff ff       	call   80104ab0 <memset>
...
8010594a:	e8 81 f3 ff ff       	call   80104cd0 <fetchint>
...
80105968:	e8 a3 f3 ff ff       	call   80104d10 <fetchstr>
...
801059d1:	e8 da f3 ff ff       	call   80104db0 <argptr>
801059d6:	83 c4 10             	add    $0x10,%esp
801059d9:	85 c0                	test   %eax,%eax
801059db:	0f 88 8b 00 00 00    	js     80105a6c <sys_pipe+0xac>
    return -1;
  if(pipealloc(&rf, &wf) < 0)
801059e1:	83 ec 08             	sub    $0x8,%esp
801059e4:	8d 45 e4             	lea    -0x1c(%ebp),%eax
801059e7:	50                   	push   %eax
801059e8:	8d 45 e0             	lea    -0x20(%ebp),%eax
801059eb:	50                   	push   %eax
801059ec:	e8 1f da ff ff       	call   80103410 <pipealloc>
801059f1:	83 c4 10             	add    $0x10,%esp
801059f4:	85 c0                	test   %eax,%eax
801059f6:	78 74                	js     80105a6c <sys_pipe+0xac>
    return -1;
  fd0 = -1;
  if((fd0 = fdalloc(rf)) < 0 || (fd1 = fdalloc(wf)) < 0){
801059f8:	8b 7d e0             	mov    -0x20(%ebp),%edi
  for(fd = 0; fd < NOFILE; fd++){
801059fb:	31 db                	xor    %ebx,%ebx
  struct proc *curproc = myproc();
801059fd:	e8 3e e0 ff ff       	call   80103a40 <myproc>
    if(curproc->ofile[fd] == 0){
80105a02:	8b 74 98 28          	mov    0x28(%eax,%ebx,4),%esi
80105a06:	85 f6                	test   %esi,%esi
80105a08:	74 16                	je     80105a20 <sys_pipe+0x60>
80105a0a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
  for(fd = 0; fd < NOFILE; fd++){
80105a10:	83 c3 01             	add    $0x1,%ebx
80105a13:	83 fb 10             	cmp    $0x10,%ebx
80105a16:	74 3d                	je     80105a55 <sys_pipe+0x95>
    if(curproc->ofile[fd] == 0){
...
80105a3e:	74 38                	je     80105a78 <sys_pipe+0xb8>
  for(fd = 0; fd < NOFILE; fd++){
...
80105a46:	75 f0                	jne    80105a38 <sys_pipe+0x78>
    if(fd0 >= 0)
      myproc()->ofile[fd0] = 0;
80105a48:	e8 f3 df ff ff       	call   80103a40 <myproc>
80105a4d:	c7 44 b0 08 00 00 00 	movl   $0x0,0x8(%eax,%esi,4)
80105a54:	00 
    fileclose(rf);
80105a55:	83 ec 0c             	sub    $0xc,%esp
80105a58:	ff 75 e0             	push   -0x20(%ebp)
80105a5b:	e8 b0 b4 ff ff       	call   80100f10 <fileclose>
    fileclose(wf);
80105a60:	58                   	pop    %eax
80105a61:	ff 75 e4             	push   -0x1c(%ebp)
80105a64:	e8 a7 b4 ff ff       	call   80100f10 <fileclose>
    return -1;
80105a69:	83 c4 10             	add    $0x10,%esp
    return -1;
80105a6c:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105a71:	eb 16                	jmp    80105a89 <sys_pipe+0xc9>
80105a73:	2e 8d 74 26 00       	lea    %cs:0x0(%esi,%eiz,1),%esi
      curproc->ofile[fd] = f;
80105a78:	89 7c 90 28          	mov    %edi,0x28(%eax,%edx,4)
  }
  fd[0] = fd0;
...
{
  return fork();
80105aa0:	e9 3b e1 ff ff       	jmp    80103be0 <fork>
80105aa5:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
80105aac:	00 
...
80105ab3:	83 ec 08             	sub    $0x8,%esp
  exit();
80105ab6:	e8 a5 e3 ff ff       	call   80103e60 <exit>
...
{
  return wait();
80105ac0:	e9 db e4 ff ff       	jmp    80103fa0 <wait>
...
80105adc:	e8 7f f2 ff ff       	call   80104d60 <argint>
...
80105aee:	e8 4d e7 ff ff       	call   80104240 <kill>
...
80105b13:	83 ec 08             	sub    $0x8,%esp
  return myproc()->pid;
80105b16:	e8 25 df ff ff       	call   80103a40 <myproc>
...
80105b37:	78 27                	js     80105b60 <sys_sbrk+0x40>
    return -1;
  addr = myproc()->sz;
80105b39:	e8 02 df ff ff       	call   80103a40 <myproc>
  if(growproc(n) < 0)
...
80105b46:	e8 15 e0 ff ff       	call   80103b60 <growproc>
...
80105b87:	78 64                	js     80105bed <sys_sleep+0x7d>
    return -1;
  acquire(&tickslock);
80105b89:	83 ec 0c             	sub    $0xc,%esp
80105b8c:	68 80 4e 11 80       	push   $0x80114e80
80105b91:	e8 1a ee ff ff       	call   801049b0 <acquire>
  ticks0 = ticks;
  while(ticks - ticks0 < n){
80105b96:	8b 55 f4             	mov    -0xc(%ebp),%edx
  ticks0 = ticks;
80105b99:	8b 1d 60 4e 11 80    	mov    0x80114e60,%ebx
  while(ticks - ticks0 < n){
80105b9f:	83 c4 10             	add    $0x10,%esp
80105ba2:	85 d2                	test   %edx,%edx
80105ba4:	75 2b                	jne    80105bd1 <sys_sleep+0x61>
80105ba6:	eb 58                	jmp    80105c00 <sys_sleep+0x90>
...
80105bb3:	68 80 4e 11 80       	push   $0x80114e80
80105bb8:	68 60 4e 11 80       	push   $0x80114e60
80105bbd:	e8 5e e5 ff ff       	call   80104120 <sleep>
  while(ticks - ticks0 < n){
80105bc2:	a1 60 4e 11 80       	mov    0x80114e60,%eax
...
80105bcf:	73 2f                	jae    80105c00 <sys_sleep+0x90>
    if(myproc()->killed){
80105bd1:	e8 6a de ff ff       	call   80103a40 <myproc>
...
80105be0:	68 80 4e 11 80       	push   $0x80114e80
80105be5:	e8 66 ed ff ff       	call   80104950 <release>
      return -1;
...
80105c03:	68 80 4e 11 80       	push   $0x80114e80
80105c08:	e8 43 ed ff ff       	call   80104950 <release>
}
...
80105c24:	83 ec 10             	sub    $0x10,%esp
  ...
  acquire(&tickslock);
80105c27:	68 80 4e 11 80       	push   $0x80114e80
80105c2c:	e8 7f ed ff ff       	call   801049b0 <acquire>
  xticks = ticks;
80105c31:	8b 1d 60 4e 11 80    	mov    0x80114e60,%ebx
  release(&tickslock);
80105c37:	c7 04 24 80 4e 11 80 	movl   $0x80114e80,(%esp)
80105c3e:	e8 0d ed ff ff       	call   80104950 <release>
  return xticks;
}
...
80105c50 <sys_getnumproc>:

int 
sys_getnumproc(void){
  return getNumProc();
80105c50:	e9 2b e7 ff ff       	jmp    80104380 <getNumProc>
80105c55:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
80105c5c:	00 
80105c5d:	8d 76 00             	lea    0x0(%esi),%esi

80105c60 <sys_getmaxpid>:
}

int
sys_getmaxpid(void){
  return getMaxPid();
80105c60:	e9 6b e7 ff ff       	jmp    801043d0 <getMaxPid>
80105c65:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
80105c6c:	00 
80105c6d:	8d 76 00             	lea    0x0(%esi),%esi

80105c70 <sys_getprocinfo>:
}
...
80105cf8:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
80105cff:	00 
...
80105d3e:	00 00 ef 
  initlock(&tickslock, "time");
80105d41:	68 1e 7a 10 80       	push   $0x80107a1e
...
80105d54:	66 a3 c6 50 11 80    	mov    %ax,0x801150c6
  initlock(&tickslock, "time");
80105d5a:	e8 61 ea ff ff       	call   801047c0 <initlock>
}
...
80105dc4:	ff 24 85 a4 7f 10 80 	jmp    *-0x7fef805c(,%eax,4)
80105dcb:	2e 8d 74 26 00       	lea    %cs:0x0(%esi,%eiz,1),%esi
  ...
  case T_IRQ0 + IRQ_IDE:
    ideintr();
80105dd0:	e8 5b c4 ff ff       	call   80102230 <ideintr>
    lapiceoi();
80105dd5:	e8 16 cb ff ff       	call   801028f0 <lapiceoi>
  }
...
80105dda:	e8 61 dc ff ff       	call   80103a40 <myproc>
80105ddf:	85 c0                	test   %eax,%eax
80105de1:	74 1a                	je     80105dfd <trap+0x5d>
80105de3:	e8 58 dc ff ff       	call   80103a40 <myproc>
...
80105dfd:	e8 3e dc ff ff       	call   80103a40 <myproc>
80105e02:	85 c0                	test   %eax,%eax
80105e04:	74 0f                	je     80105e15 <trap+0x75>
80105e06:	e8 35 dc ff ff       	call   80103a40 <myproc>
...
80105e0f:	0f 84 ab 00 00 00    	je     80105ec0 <trap+0x120>
  ...
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105e15:	e8 26 dc ff ff       	call   80103a40 <myproc>
80105e1a:	85 c0                	test   %eax,%eax
80105e1c:	74 1a                	je     80105e38 <trap+0x98>
80105e1e:	e8 1d dc ff ff       	call   80103a40 <myproc>
...
80105e40:	e8 fb db ff ff       	call   80103a40 <myproc>
...
80105e71:	e8 ca db ff ff       	call   80103a40 <myproc>
...
80105e95:	68 6c 7c 10 80       	push   $0x80107c6c
80105e9a:	e8 11 a8 ff ff       	call   801006b0 <cprintf>
    myproc()->killed = 1;
80105e9f:	83 c4 20             	add    $0x20,%esp
80105ea2:	e8 99 db ff ff       	call   80103a40 <myproc>
80105ea7:	c7 40 24 01 00 00 00 	movl   $0x1,0x24(%eax)
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105eae:	e8 8d db ff ff       	call   80103a40 <myproc>
...
80105ec4:	0f 85 4b ff ff ff    	jne    80105e15 <trap+0x75>
    yield();
80105eca:	e8 01 e2 ff ff       	call   801040d0 <yield>
...
80105edf:	e8 3c db ff ff       	call   80103a20 <cpuid>
80105ee4:	57                   	push   %edi
80105ee5:	56                   	push   %esi
80105ee6:	50                   	push   %eax
80105ee7:	68 14 7c 10 80       	push   $0x80107c14
80105eec:	e8 bf a7 ff ff       	call   801006b0 <cprintf>
    lapiceoi();
80105ef1:	e8 fa c9 ff ff       	call   801028f0 <lapiceoi>
    break;
80105ef6:	83 c4 10             	add    $0x10,%esp
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105ef9:	e8 42 db ff ff       	call   80103a40 <myproc>
...
80105f25:	89 58 18             	mov    %ebx,0x18(%eax)
    syscall();
80105f28:	e8 73 ef ff ff       	call   80104ea0 <syscall>
    if(myproc()->killed)
80105f2d:	e8 0e db ff ff       	call   80103a40 <myproc>
...
80105f43:	5d                   	pop    %ebp
      exit();
80105f44:	e9 17 df ff ff       	jmp    80103e60 <exit>
80105f49:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    uartintr();
80105f50:	e8 4b 02 00 00       	call   801061a0 <uartintr>
    lapiceoi();
80105f55:	e8 96 c9 ff ff       	call   801028f0 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105f5a:	e8 e1 da ff ff       	call   80103a40 <myproc>
...
80105f6c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    kbdintr();
80105f70:	e8 4b c8 ff ff       	call   801027c0 <kbdintr>
    lapiceoi();
80105f75:	e8 76 c9 ff ff       	call   801028f0 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105f7a:	e8 c1 da ff ff       	call   80103a40 <myproc>
...
80105f8c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    if(cpuid() == 0){
80105f90:	e8 8b da ff ff       	call   80103a20 <cpuid>
...
801060a7:	0f 84 7c 00 00 00    	je     80106129 <uartinit+0xd9>
  uart = 1;
801060ad:	c7 05 c0 56 11 80 01 	movl   $0x1,0x801156c0
801060b4:	00 00 00 
...
801060c0:	83 ec 08             	sub    $0x8,%esp
  for(p="xv6...\n"; *p; p++)
801060c3:	bf 28 7a 10 80       	mov    $0x80107a28,%edi
801060c8:	be fd 03 00 00       	mov    $0x3fd,%esi
  ioapicenable(IRQ_COM1, 0);
801060cd:	6a 00                	push   $0x0
801060cf:	6a 04                	push   $0x4
801060d1:	e8 8a c3 ff ff       	call   80102460 <ioapicenable>
...
80106140 <uartputc>:
  if(!uart)
80106140:	a1 c0 56 11 80       	mov    0x801156c0,%eax
...
8010616d:	e8 9e c7 ff ff       	call   80102910 <microdelay>
  for(i = 0; i < 128 && !(inb(COM1+5) & 0x20); i++)
...
80106ccb:	e8 d0 b7 ff ff       	call   801024a0 <kfree>
      *pte = 0;
...
80106ce1:	68 cc 77 10 80       	push   $0x801077cc
...
80106d70:	e8 eb b8 ff ff       	call   80102660 <kalloc>
...
80106d87:	e8 24 dd ff ff       	call   80104ab0 <memset>
...
80106dcd:	68 30 7a 10 80       	push   $0x80107a30
...
80106de3:	83 ec 18             	sub    $0x18,%esp
  c = &cpus[cpuid()];
80106de6:	e8 35 cc ff ff       	call   80103a20 <cpuid>
  pd[0] = size-1;
...
80106e70:	a1 c4 56 11 80       	mov    0x801156c4,%eax
...
80106ea4:	0f 84 c2 00 00 00    	je     80106f6c <switchuvm+0xec>
  pushcli();
80106eaa:	e8 b1 d9 ff ff       	call   80104860 <pushcli>
  mycpu()->gdt[SEG_TSS] = SEG16(STS_T32A, &mycpu()->ts,
80106eaf:	e8 0c cb ff ff       	call   801039c0 <mycpu>
80106eb4:	89 c3                	mov    %eax,%ebx
80106eb6:	e8 05 cb ff ff       	call   801039c0 <mycpu>
80106ebb:	89 c7                	mov    %eax,%edi
80106ebd:	e8 fe ca ff ff       	call   801039c0 <mycpu>
80106ec2:	83 c7 08             	add    $0x8,%edi
80106ec5:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80106ec8:	e8 f3 ca ff ff       	call   801039c0 <mycpu>
...
80106fab:	77 49                	ja     80106ff6 <inituvm+0x66>
  mem = kalloc();
80106fad:	e8 ae b6 ff ff       	call   80102660 <kalloc>
  memset(mem, 0, PGSIZE);
...
80106fbf:	e8 ec da ff ff       	call   80104ab0 <memset>
...
80106ff0:	5d                   	pop    %ebp
  memmove(mem, init, sz);
80106ff1:	e9 4a db ff ff       	jmp    80104b40 <memmove>
    panic("inituvm: more than a page");
80106ff6:	83 ec 0c             	sub    $0xc,%esp
80106ff9:	68 75 7a 10 80       	push   $0x80107a75
...
80107048:	68 8f 7a 10 80       	push   $0x80107a8f
...
80107096:	e8 15 aa ff ff       	call   80101ab0 <readi>
...
801070d0:	68 b0 7c 10 80       	push   $0x80107cb0
...
8010712b:	e8 80 d9 ff ff       	call   80104ab0 <memset>
...
80107159:	0f 83 89 00 00 00    	jae    801071e8 <allocuvm+0x108>
    mem = kalloc();
8010715f:	e8 fc b4 ff ff       	call   80102660 <kalloc>
...
8010716d:	68 ad 7a 10 80       	push   $0x80107aad
...
801071b3:	68 c5 7a 10 80       	push   $0x80107ac5
...
801071d6:	e8 c5 b2 ff ff       	call   801024a0 <kfree>
      return 0;
...
8010727e:	e8 1d b2 ff ff       	call   801024a0 <kfree>
...
80107293:	5d                   	pop    %ebp
  kfree((char*)pgdir);
80107294:	e9 07 b2 ff ff       	jmp    801024a0 <kfree>
    panic("freevm: no pgdir");
80107299:	83 ec 0c             	sub    $0xc,%esp
8010729c:	68 e1 7a 10 80       	push   $0x80107ae1
...
801072b5:	e8 a6 b3 ff ff       	call   80102660 <kalloc>
...
801072d0:	e8 db d7 ff ff       	call   80104ab0 <memset>
...
8010733b:	a3 c4 56 11 80       	mov    %eax,0x801156c4
  lcr3(V2P(kpgdir));   // switch to the kernel page table
...
8010736c:	68 f2 7a 10 80       	push   $0x80107af2
...
801073e2:	68 fc 7a 10 80       	push   $0x80107afc
...
8010741f:	81 e7 00 f0 ff ff    	and    $0xfffff000,%edi
    if((mem = kalloc()) == 0)
80107425:	e8 36 b2 ff ff       	call   80102660 <kalloc>
...
80107440:	e8 fb d6 ff ff       	call   80104b40 <memmove>
...
8010748c:	e8 0f b0 ff ff       	call   801024a0 <kfree>
      goto bad;
...
801074b7:	68 16 7b 10 80       	push   $0x80107b16
...
80107570:	e8 cb d5 ff ff       	call   80104b40 <memmove>
    len -= n;
    buf += n;
