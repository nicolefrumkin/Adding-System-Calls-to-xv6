 ...
 3a8:	89 d1                	mov    %edx,%ecx
{
 ...
 3eb:	0f b6 92 30 08 00 00 	movzbl 0x830(%edx),%edx
 ...
 641:	a1 d8 0a 00 00       	mov    0xad8,%eax
{
 ...
 689:	5b                   	pop    %ebx
  freep = p;
 68a:	89 15 d8 0a 00 00    	mov    %edx,0xad8
}
 690:	5e                   	pop    %esi
 691:	5f                   	pop    %edi
 692:	5d                   	pop    %ebp
 ...
 6c7:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 6ca:	89 15 d8 0a 00 00    	mov    %edx,0xad8
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6e9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6ec:	8b 15 d8 0a 00 00    	mov    0xad8,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 72b:	39 05 d8 0a 00 00    	cmp    %eax,0xad8
 ...
 74e:	e8 ed fe ff ff       	call   640 <free>
  return freep;
 753:	8b 15 d8 0a 00 00    	mov    0xad8,%edx
 ...
 7a6:	0a 00 00 
    base.s.size = 0;
 7a9:	c7 05 e0 0a 00 00 00 	movl   $0x0,0xae0
 7b0:	00 00 00 
    if(p->s.size >= nunits){
