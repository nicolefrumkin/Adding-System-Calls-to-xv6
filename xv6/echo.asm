...
main(int argc, char *argv[])
{
  ...
  exit();
  65:	e8 69 02 00 00       	call   2d3 <exit>
  6a:	66 90                	xchg   %ax,%ax
  6c:	66 90                	xchg   %ax,%ax
  6e:	66 90                	xchg   %ax,%ax
  70:	66 90                	xchg   %ax,%ax
 ...
 388:	89 d1                	mov    %edx,%ecx
{
 ...
 3cb:	0f b6 92 10 08 00 00 	movzbl 0x810(%edx),%edx
 ...
 449:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 4b3:	ff 24 85 b8 07 00 00 	jmp    *0x7b8(,%eax,4)
 ...
 5e8:	bf b1 07 00 00       	mov    $0x7b1,%edi
...
free(void *ap)
{
 ...
 621:	a1 b8 0a 00 00       	mov    0xab8,%eax
{
 ...
 669:	5b                   	pop    %ebx
  freep = p;
 66a:	89 15 b8 0a 00 00    	mov    %edx,0xab8
}
 670:	5e                   	pop    %esi
 671:	5f                   	pop    %edi
 672:	5d                   	pop    %ebp
 ...
 6a7:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 6aa:	89 15 b8 0a 00 00    	mov    %edx,0xab8
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6c9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6cc:	8b 15 b8 0a 00 00    	mov    0xab8,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 70b:	39 05 b8 0a 00 00    	cmp    %eax,0xab8
 ...
 72e:	e8 ed fe ff ff       	call   620 <free>
  return freep;
 733:	8b 15 b8 0a 00 00    	mov    0xab8,%edx
 ...
 75c:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 75f:	89 15 b8 0a 00 00    	mov    %edx,0xab8
}
 ...
 76f:	c3                   	ret
    base.s.ptr = freep = prevp = &base;
 770:	c7 05 b8 0a 00 00 bc 	movl   $0xabc,0xab8
 777:	0a 00 00 
    base.s.size = 0;
 77a:	b8 bc 0a 00 00       	mov    $0xabc,%eax
    base.s.ptr = freep = prevp = &base;
 77f:	c7 05 bc 0a 00 00 bc 	movl   $0xabc,0xabc
 786:	0a 00 00 
    base.s.size = 0;
 789:	c7 05 c0 0a 00 00 00 	movl   $0x0,0xac0
 790:	00 00 00 
    if(p->s.size >= nunits){
